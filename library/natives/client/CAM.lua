...
---**`CAM` `client` [`0x0AA27680A0BD43FA`](https://docs.fivem.net/natives/?_0x0AA27680A0BD43FA)**
---
...
---**`CAM` `client` [`0x17FCA7199A530203`](https://docs.fivem.net/natives/?_0x17FCA7199A530203)**
---
function N_0x17fca7199a530203() end

---**`CAM` `client` [`0x1F2300CB7FA7B7F6`](https://docs.fivem.net/natives/?_0x1F2300CB7FA7B7F6)**
---
---@return any
function N_0x1f2300cb7fa7b7f6() end

---**`CAM` `client` [`0x202A5ED9CE01D6E7`](https://docs.fivem.net/natives/?_0x202A5ED9CE01D6E7)**
---
---```
...
---**`CAM` `client` [`0x247ACBC4ABBC9D1C`](https://docs.fivem.net/natives/?_0x247ACBC4ABBC9D1C)**
---
---@param p0 boolean
function N_0x247acbc4abbc9d1c(p0) end

---**`CAM` `client` [`0x271017B9BA825366`](https://docs.fivem.net/natives/?_0x271017B9BA825366)**
---
---@param p0 any
---@param p1 boolean
function N_0x271017b9ba825366(p0, p1) end

---**`CAM` `client` [`0x271401846BD26E92`](https://docs.fivem.net/natives/?_0x271401846BD26E92)**
---
---@param p0 boolean
---@param p1 boolean
function N_0x271401846bd26e92(p0, p1) end

---**`CAM` `client` [`0x28B022A17B068A3A`](https://docs.fivem.net/natives/?_0x28B022A17B068A3A)**
---
---F\*
---
---```
...
---**`CAM` `client` [`0x2F7F2B26DD3F18EE`](https://docs.fivem.net/natives/?_0x2F7F2B26DD3F18EE)**
---
---@param p0 number
---@param p1 number
function N_0x2f7f2b26dd3f18ee(p0, p1) end

---**`CAM` `client` [`0x3044240D2E0FA842`](https://docs.fivem.net/natives/?_0x3044240D2E0FA842)**
---
---@return boolean
function N_0x3044240d2e0fa842() end

---**`CAM` `client` [`0x324C5AA411DA7737`](https://docs.fivem.net/natives/?_0x324C5AA411DA7737)**
---
---```
...
---**`CAM` `client` [`0x380B4968D1E09E55`](https://docs.fivem.net/natives/?_0x380B4968D1E09E55)**
---
---```
...
---**`CAM` `client` [`0x4008EDF7D6E48175`](https://docs.fivem.net/natives/?_0x4008EDF7D6E48175)**
---
---@param p0 boolean
function N_0x4008edf7d6e48175(p0) end

---**`CAM` `client` [`0x469F2ECDEC046337`](https://docs.fivem.net/natives/?_0x469F2ECDEC046337)**
---
---@param p0 boolean
function N_0x469f2ecdec046337(p0) end

---**`CAM` `client` [`0x4879E4FE39074CDF`](https://docs.fivem.net/natives/?_0x4879E4FE39074CDF)**
---
---```
---A*
---```
...
---**`CAM` `client` [`0x59424BD75174C9B1`](https://docs.fivem.net/natives/?_0x59424BD75174C9B1)**
---
function N_0x59424bd75174c9b1() end

---**`CAM` `client` [`0x5A43C76F7FC7BA5F`](https://docs.fivem.net/natives/?_0x5A43C76F7FC7BA5F)**
---
function N_0x5a43c76f7fc7ba5f() end

---**`CAM` `client` [`0x5C41E6BABC9E2112`](https://docs.fivem.net/natives/?_0x5C41E6BABC9E2112)**
---
---@param p0 any
function N_0x5c41e6babc9e2112(p0) end

---**`CAM` `client` [`0x5C48A1D6E3B33179`](https://docs.fivem.net/natives/?_0x5C48A1D6E3B33179)**
---
---```
---W*
---```
...
---**`CAM` `client` [`0x5D96CFB59DA076A0`](https://docs.fivem.net/natives/?_0x5D96CFB59DA076A0)**
---
---p1: 0..16
---
---```
...
---**`CAM` `client` [`0x62374889A4D59F72`](https://docs.fivem.net/natives/?_0x62374889A4D59F72)**
---
function N_0x62374889a4d59f72() end

---**`CAM` `client` [`0x62ECFCFDEE7885D6`](https://docs.fivem.net/natives/?_0x62ECFCFDEE7885D6)**
---
function N_0x62ecfcfdee7885d6() end

---**`CAM` `client` [`0x661B5C8654ADD825`](https://docs.fivem.net/natives/?_0x661B5C8654ADD825)**
---
---```
---SET_CAM_*
---```
...
---**`CAM` `client` [`0x705A276EBFF3133D`](https://docs.fivem.net/natives/?_0x705A276EBFF3133D)**
---
---@return boolean
function N_0x705a276ebff3133d() end

---**`CAM` `client` [`0x7295C203DD659DFE`](https://docs.fivem.net/natives/?_0x7295C203DD659DFE)**
---
---```
---_RESET_*
---
...
---**`CAM` `client` [`0x91EF6EE6419E5B97`](https://docs.fivem.net/natives/?_0x91EF6EE6419E5B97)**
---
---@param p0 boolean
function N_0x91ef6ee6419e5b97(p0) end

---**`CAM` `client` [`0x9DFE13ECDC1EC196`](https://docs.fivem.net/natives/?_0x9DFE13ECDC1EC196)**
---
---```
---SET_FOLLOW_*
---```
...
---**`CAM` `client` [`0x9F97DA93681F87EA`](https://docs.fivem.net/natives/?_0x9F97DA93681F87EA)**
---
---B\*
---
---```
...
---**`CAM` `client` [`0xA2767257A320FC82`](https://docs.fivem.net/natives/?_0xA2767257A320FC82)**
---
---@param p0 any
---@param p1 boolean
function N_0xa2767257a320fc82(p0, p1) end

---**`CAM` `client` [`0xA7092AFE81944852`](https://docs.fivem.net/natives/?_0xA7092AFE81944852)**
---
---```
---NativeDB Introduced: v2189
---```
...
---**`CAM` `client` [`0xAABD62873FFB1A33`](https://docs.fivem.net/natives/?_0xAABD62873FFB1A33)**
---
---```
---NativeDB Introduced: v2189
---```
...
---**`CAM` `client` [`0xB1381B97F70C7B30`](https://docs.fivem.net/natives/?_0xB1381B97F70C7B30)**
---
---```
...
---**`CAM` `client` [`0xBF72910D0F26F025`](https://docs.fivem.net/natives/?_0xBF72910D0F26F025)**
---
---@return any
function N_0xbf72910d0f26f025() end

---**`CAM` `client` [`0xC8391C309684595A`](https://docs.fivem.net/natives/?_0xC8391C309684595A)**
---
function N_0xc8391c309684595a() end

---**`CAM` `client` [`0xC8B5C4A79CC18B94`](https://docs.fivem.net/natives/?_0xC8B5C4A79CC18B94)**
---
---@param cam Cam
function N_0xc8b5c4a79cc18b94(cam) end

---**`CAM` `client` [`0xCCD078C2665D2973`](https://docs.fivem.net/natives/?_0xCCD078C2665D2973)**
---
...
---**`CAM` `client` [`0xCED08CBE8EBB97C7`](https://docs.fivem.net/natives/?_0xCED08CBE8EBB97C7)**
---
---@param p0 number
---@param p1 number
function N_0xced08cbe8ebb97c7(p0, p1) end

---**`CAM` `client` [`0xDB90C6CCA48940F1`](https://docs.fivem.net/natives/?_0xDB90C6CCA48940F1)**
---
---@param p0 boolean
function N_0xdb90c6cca48940f1(p0) end

---**`CAM` `client` [`0xDD79DF9F4D26E1C9`](https://docs.fivem.net/natives/?_0xDD79DF9F4D26E1C9)**
---
function N_0xdd79df9f4d26e1c9() end

---**`CAM` `client` [`0xE111A7C0D200CBC5`](https://docs.fivem.net/natives/?_0xE111A7C0D200CBC5)**
---
---@param p0 any
---@param p1 number
function N_0xe111a7c0d200cbc5(p0, p1) end

---**`CAM` `client` [`0xEAF0FA793D05C592`](https://docs.fivem.net/natives/?_0xEAF0FA793D05C592)**
---
---@return any
function N_0xeaf0fa793d05c592() end

---**`CAM` `client` [`0xF55E4046F6F831DC`](https://docs.fivem.net/natives/?_0xF55E4046F6F831DC)**
---
---@param p0 any
---@param p1 number
function N_0xf55e4046f6f831dc(p0, p1) end

---**`CAM` `client` [`0xFD3151CD37EA2245`](https://docs.fivem.net/natives/?_0xFD3151CD37EA2245)**
---
---@param entity Entity
...
---**`CAM` `client` [`0x0FB82563989CF4FB`](https://docs.fivem.net/natives/?_0x0FB82563989CF4FB)**
---
...
---**`CAM` `client` [`0x0A9F2A468B328E74`](https://docs.fivem.net/natives/?_0x0A9F2A468B328E74)**
---
---@param cam Cam
---@param cam2 Cam
---@param p2 number
...
---**`CAM` `client` [`0x609278246A29CA34`](https://docs.fivem.net/natives/?_0x609278246A29CA34)**
---
---@param cam Cam
---@param p1 number
---@param p2 number
...
---**`CAM` `client` [`0xC2EAE3FB8CDBED31`](https://docs.fivem.net/natives/?_0xC2EAE3FB8CDBED31)**
---
---```
...
---@return Cam # A camera handle referencing the camera that was created.
function CreateCam(camName, active) end

---**`CAM` `client` [`0x5E3CF89C6BCCA67D`](https://docs.fivem.net/natives/?_0x5E3CF89C6BCCA67D)**
---
---@param camHash Hash
...
---**`CAM` `client` [`0x6ABFA3E16460F22D`](https://docs.fivem.net/natives/?_0x6ABFA3E16460F22D)**
---
...
---**`CAM` `client` [`0xB51194800B257161`](https://docs.fivem.net/natives/?_0xB51194800B257161)**
---
...
---@return Cam # A camera handle.
function CreateCamWithParams(camName, posX, posY, posZ, rotX, rotY, rotZ, fov, active, rotationOrder) end

---**`CAM` `client` [`0x741B0129D4560F31`](https://docs.fivem.net/natives/?_0x741B0129D4560F31)**
---
---@param p0 any
---@param p1 number
---@param p2 any
...
---**`CAM` `client` [`0xA2FABBE87F4BAD82`](https://docs.fivem.net/natives/?_0xA2FABBE87F4BAD82)**
---
---@param cam Cam
function DetachCam(cam) end

---**`CAM` `client` [`0x1A31FE0049E542F6`](https://docs.fivem.net/natives/?_0x1A31FE0049E542F6)**
---
function DisableAimCamThisUpdate() end

---**`CAM` `client` [`0x49482F9FCD825AAA`](https://docs.fivem.net/natives/?_0x49482F9FCD825AAA)**
---
---@param entity Entity
function DisableCamCollisionForObject(entity) end

---**`CAM` `client` [`0xA7A932170592B50E`](https://docs.fivem.net/natives/?_0xA7A932170592B50E)**
---
...
---**`CAM` `client` [`0xA41BCD7213805AAC`](https://docs.fivem.net/natives/?_0xA41BCD7213805AAC)**
---
---@param p0 boolean
function ForceCinematicRenderingThisUpdate(p0) end

---**`CAM` `client` [`0xA10B2DB49E92A6B0`](https://docs.fivem.net/natives/?_0xA10B2DB49E92A6B0)**
---
---@param cam Cam
---@return number
function GetCamAnimCurrentPhase(cam) end

---**`CAM` `client` [`0xBAC038F7459AE5AE`](https://docs.fivem.net/natives/?_0xBAC038F7459AE5AE)**
---
---@param cam Cam
---@return vector3
function GetCamCoord(cam) end

---**`CAM` `client` [`0xB60A9CFEB21CA6AA`](https://docs.fivem.net/natives/?_0xB60A9CFEB21CA6AA)**
---
---@param cam Cam
---@return number
function GetCamFarClip(cam) end

---**`CAM` `client` [`0x255F8DAFD540D397`](https://docs.fivem.net/natives/?_0x255F8DAFD540D397)**
---
---@param cam Cam
---@return number
function GetCamFarDof(cam) end

---**`CAM` `client` [`0xC3330A45CCCDB26A`](https://docs.fivem.net/natives/?_0xC3330A45CCCDB26A)**
---
---@param cam Cam
---@return number
function GetCamFov(cam) end

---**`CAM` `client` [`0xC520A34DAFBF24B1`](https://docs.fivem.net/natives/?_0xC520A34DAFBF24B1)**
---
---@param cam Cam
---@return number
function GetCamNearClip(cam) end

---**`CAM` `client` [`0x7D304C1C955E3E12`](https://docs.fivem.net/natives/?_0x7D304C1C955E3E12)**
---
...
---**`CAM` `client` [`0xB22B17DF858716A6`](https://docs.fivem.net/natives/?_0xB22B17DF858716A6)**
---
---@param cam Cam
---@return number
...
---**`CAM` `client` [`0xEE778F8C7E1142E2`](https://docs.fivem.net/natives/?_0xEE778F8C7E1142E2)**
---
...
---**`CAM` `client` [`0xA200EB1EE790F448`](https://docs.fivem.net/natives/?_0xA200EB1EE790F448)**
---
---@return vector3
function GetFinalRenderedCamCoord() end

---**`CAM` `client` [`0xDFC8CBC606FDB0FC`](https://docs.fivem.net/natives/?_0xDFC8CBC606FDB0FC)**
---
---@return number
function GetFinalRenderedCamFarClip() end

---**`CAM` `client` [`0x9780F32BCAF72431`](https://docs.fivem.net/natives/?_0x9780F32BCAF72431)**
---
---@return number
function GetFinalRenderedCamFarDof() end

---**`CAM` `client` [`0x80EC114669DAEFF4`](https://docs.fivem.net/natives/?_0x80EC114669DAEFF4)**
---
---@return number
function GetFinalRenderedCamFov() end

---**`CAM` `client` [`0x162F9D995753DC19`](https://docs.fivem.net/natives/?_0x162F9D995753DC19)**
---
---@return number
function GetFinalRenderedCamMotionBlurStrength() end

---**`CAM` `client` [`0xD0082607100D7193`](https://docs.fivem.net/natives/?_0xD0082607100D7193)**
---
---@return number
function GetFinalRenderedCamNearClip() end

---**`CAM` `client` [`0xA03502FC581F7D9B`](https://docs.fivem.net/natives/?_0xA03502FC581F7D9B)**
---
---@return number
function GetFinalRenderedCamNearDof() end

---**`CAM` `client` [`0x5B4E4C817FCC2DFB`](https://docs.fivem.net/natives/?_0x5B4E4C817FCC2DFB)**
---
---@param rotationOrder number
---@return vector3
function GetFinalRenderedCamRot(rotationOrder) end

---**`CAM` `client` [`0x5F35F6732C3FBBA0`](https://docs.fivem.net/natives/?_0x5F35F6732C3FBBA0)**
---
---@param player Player
---@return number
function GetFinalRenderedInWhenFriendlyFov(player) end

---**`CAM` `client` [`0x26903D9CD1175F2C`](https://docs.fivem.net/natives/?_0x26903D9CD1175F2C)**
---
---@param player Player
---@param rotationOrder number
---@return vector3
...
---**`CAM` `client` [`0x7EC52CC40597D170`](https://docs.fivem.net/natives/?_0x7EC52CC40597D170)**
---
---@return number
function GetFirstPersonAimCamZoomFactor() end

---**`CAM` `client` [`0x89215EC747DF244A`](https://docs.fivem.net/natives/?_0x89215EC747DF244A)**
---
---@param p0 number
---@param p1 number
---@param p2 number
...
---**`CAM` `client` [`0x8D4D46230B2C353A`](https://docs.fivem.net/natives/?_0x8D4D46230B2C353A)**
---
---```cpp
...
---**`CAM` `client` [`0x33E6C8EFD0CD93E9`](https://docs.fivem.net/natives/?_0x33E6C8EFD0CD93E9)**
---
...
---**`CAM` `client` [`0xA4FF579AC0E3AAAE`](https://docs.fivem.net/natives/?_0xA4FF579AC0E3AAAE)**
---
---See [`GET_FOLLOW_PED_CAM_VIEW_MODE`](#\_0x8D4D46230B2C353A) for the follow mode enum.
---
---@return number
...
---**`CAM` `client` [`0xEE82280AB767B690`](https://docs.fivem.net/natives/?_0xEE82280AB767B690)**
---
---See [`GET_FOLLOW_PED_CAM_VIEW_MODE`](#\_0x8D4D46230B2C353A) for the follow mode enum.
---
---@return number
...
---**`CAM` `client` [`0x14D6F5678D8F1B37`](https://docs.fivem.net/natives/?_0x14D6F5678D8F1B37)**
---
---@return vector3
function GetGameplayCamCoord() end

---**`CAM` `client` [`0x65019750A0324133`](https://docs.fivem.net/natives/?_0x65019750A0324133)**
---
---@return number
function GetGameplayCamFov() end

---**`CAM` `client` [`0x743607648ADD4587`](https://docs.fivem.net/natives/?_0x743607648ADD4587)**
---
---@return number
function GetGameplayCamRelativeHeading() end

---**`CAM` `client` [`0x3A6867B4845BEDA2`](https://docs.fivem.net/natives/?_0x3A6867B4845BEDA2)**
---
---Example code:
---```lua
...
---**`CAM` `client` [`0x837765A25378F0BB`](https://docs.fivem.net/natives/?_0x837765A25378F0BB)**
---
...
---**`CAM` `client` [`0x5234F9F10919EABA`](https://docs.fivem.net/natives/?_0x5234F9F10919EABA)**
---
---@return Cam
function GetRenderingCam() end

---**`CAM` `client` [`0xF4F2C0D4EE209E20`](https://docs.fivem.net/natives/?_0xF4F2C0D4EE209E20)**
---
...
---**`CAM` `client` [`0x68EDDA28A5976D07`](https://docs.fivem.net/natives/?_0x68EDDA28A5976D07)**
---
---@return boolean
function IsAimCamActive() end

---**`CAM` `client` [`0xD7360051C885628B`](https://docs.fivem.net/natives/?_0xD7360051C885628B)**
---
---@return boolean
...
---**`CAM` `client` [`0x036F97C908C2B52C`](https://docs.fivem.net/natives/?_0x036F97C908C2B52C)**
---
---@param cam Cam
---@return boolean
function IsCamInterpolating(cam) end

---**`CAM` `client` [`0xC90621D8A0CEECF2`](https://docs.fivem.net/natives/?_0xC90621D8A0CEECF2)**
---
...
---**`CAM` `client` [`0x02EC0AF5C5A49B7A`](https://docs.fivem.net/natives/?_0x02EC0AF5C5A49B7A)**
---
---@param cam Cam
---@return boolean
function IsCamRendering(cam) end

---**`CAM` `client` [`0x6B24BFE83A2BE47B`](https://docs.fivem.net/natives/?_0x6B24BFE83A2BE47B)**
---
---@param cam Cam
---@return boolean
function IsCamShaking(cam) end

---**`CAM` `client` [`0x0290F35C0AD97864`](https://docs.fivem.net/natives/?_0x0290F35C0AD97864)**
---
---@param p0 any
---@return boolean
function IsCamSplinePaused(p0) end

---**`CAM` `client` [`0xF5F1E89A970B7796`](https://docs.fivem.net/natives/?_0xF5F1E89A970B7796)**
---
---```
...
---**`CAM` `client` [`0xB15162CB5826E9E8`](https://docs.fivem.net/natives/?_0xB15162CB5826E9E8)**
---
---@return boolean
function IsCinematicCamRendering() end

---**`CAM` `client` [`0xBBC08F6B4CB8FF0A`](https://docs.fivem.net/natives/?_0xBBC08F6B4CB8FF0A)**
---
---@return boolean
function IsCinematicCamShaking() end

---**`CAM` `client` [`0xCA9D2AA3E326D720`](https://docs.fivem.net/natives/?_0xCA9D2AA3E326D720)**
---
---@return boolean
function IsCinematicIdleCamRendering() end

---**`CAM` `client` [`0xCC9F3371A7C28BC9`](https://docs.fivem.net/natives/?_0xCC9F3371A7C28BC9)**
---
---@param p0 any
---@return boolean
function IsCinematicShotActive(p0) end

---**`CAM` `client` [`0x5E346D934122613F`](https://docs.fivem.net/natives/?_0x5E346D934122613F)**
---
---@return boolean
function IsFirstPersonAimCamActive() end

---**`CAM` `client` [`0xC6D3D26810C8E0F9`](https://docs.fivem.net/natives/?_0xC6D3D26810C8E0F9)**
---
---@return boolean
function IsFollowPedCamActive() end

---**`CAM` `client` [`0xCBBDE6D335D6D496`](https://docs.fivem.net/natives/?_0xCBBDE6D335D6D496)**
---
---@return boolean
function IsFollowVehicleCamActive() end

---**`CAM` `client` [`0x70FDA869F3317EA9`](https://docs.fivem.net/natives/?_0x70FDA869F3317EA9)**
---
---@return boolean
function IsGameplayCamLookingBehind() end

---**`CAM` `client` [`0x39B5D1B10383F0C8`](https://docs.fivem.net/natives/?_0x39B5D1B10383F0C8)**
---
---```
...
---**`CAM` `client` [`0x016C090630DF1F89`](https://docs.fivem.net/natives/?_0x016C090630DF1F89)**
---
---@return boolean
function IsGameplayCamShaking() end

---**`CAM` `client` [`0xE520FF1AD2785B40`](https://docs.fivem.net/natives/?_0xE520FF1AD2785B40)**
---
---@return boolean
function IsGameplayHintActive() end

---**`CAM` `client` [`0x5A859503B0C08678`](https://docs.fivem.net/natives/?_0x5A859503B0C08678)**
---
---@return boolean
function IsScreenFadedIn() end

---**`CAM` `client` [`0xB16FCE9DDC7BA182`](https://docs.fivem.net/natives/?_0xB16FCE9DDC7BA182)**
---
---@return boolean
function IsScreenFadedOut() end

---**`CAM` `client` [`0x5C544BC6C57AC575`](https://docs.fivem.net/natives/?_0x5C544BC6C57AC575)**
---
---@return boolean
function IsScreenFadingIn() end

---**`CAM` `client` [`0x797AC7CB535BA28F`](https://docs.fivem.net/natives/?_0x797AC7CB535BA28F)**
---
---@return boolean
function IsScreenFadingOut() end

---**`CAM` `client` [`0xC912AF078AF19212`](https://docs.fivem.net/natives/?_0xC912AF078AF19212)**
---
---```
...
---**`CAM` `client` [`0xE33D59DA70B58FDF`](https://docs.fivem.net/natives/?_0xE33D59DA70B58FDF)**
---
---@param x number
---@param y number
---@param z number
...
---**`CAM` `client` [`0x40B62FA033EB0346`](https://docs.fivem.net/natives/?_0x40B62FA033EB0346)**
---
---@param cam Cam
---@param p1 number
---@param p2 number
...
---**`CAM` `client` [`0xF75497BB865F0803`](https://docs.fivem.net/natives/?_0xF75497BB865F0803)**
---
---Example code:
---```lua
...
---**`CAM` `client` [`0x5640BFF86B16E8DC`](https://docs.fivem.net/natives/?_0x5640BFF86B16E8DC)**
---
...
---**`CAM` `client` [`0x4145A4C44FF3B5A6`](https://docs.fivem.net/natives/?_0x4145A4C44FF3B5A6)**
---
---@param cam Cam
---@param phase number
...
---**`CAM` `client` [`0x3CF48F6F96E749DC`](https://docs.fivem.net/natives/?_0x3CF48F6F96E749DC)**
---
---@param cam Cam
---@param p1 number
---@param p2 number
...
---**`CAM` `client` [`0x6F0F77FBA9A8F2E6`](https://docs.fivem.net/natives/?_0x6F0F77FBA9A8F2E6)**
---
---@param cam Cam
---@param strength number
function SetCamMotionBlurStrength(cam, strength) end

---**`CAM` `client` [`0xC7848EFCCC545182`](https://docs.fivem.net/natives/?_0xC7848EFCCC545182)**
---
---@param cam Cam
...
---**`CAM` `client` [`0x85973643155D0B07`](https://docs.fivem.net/natives/?_0x85973643155D0B07)**
---
...
---**`CAM` `client` [`0xD93DB43B82BC0D00`](https://docs.fivem.net/natives/?_0xD93DB43B82BC0D00)**
---
---@param cam Cam
---@param amplitude number
...
---**`CAM` `client` [`0x83B8201ED82A9A2D`](https://docs.fivem.net/natives/?_0x83B8201ED82A9A2D)**
---
---@param cam Cam
---@param p1 number
---@param p2 number
...
---**`CAM` `client` [`0x7BF1A54AE67AC070`](https://docs.fivem.net/natives/?_0x7BF1A54AE67AC070)**
---
---@param cam Cam
---@param p1 number
---@param flags number
...
---**`CAM` `client` [`0xA6385DEB180F319F`](https://docs.fivem.net/natives/?_0xA6385DEB180F319F)**
---
---@param cam Cam
---@param p1 number
---@param scale number
...
---**`CAM` `client` [`0x242B5874F0A4E052`](https://docs.fivem.net/natives/?_0x242B5874F0A4E052)**
---
---@param cam Cam
---@param p1 number
function SetCamSplinePhase(cam, p1) end

---**`CAM` `client` [`0xD1B0F412F109EA5D`](https://docs.fivem.net/natives/?_0xD1B0F412F109EA5D)**
---
...
---**`CAM` `client` [`0x51669F7D1FB53D9F`](https://docs.fivem.net/natives/?_0x51669F7D1FB53D9F)**
---
---@param p0 boolean
function SetCinematicButtonActive(p0) end

---**`CAM` `client` [`0xC724C701C30B2FE7`](https://docs.fivem.net/natives/?_0xC724C701C30B2FE7)**
---
---@param p0 number
function SetCinematicCamShakeAmplitude(p0) end

---**`CAM` `client` [`0xDCF0754AC3D6FD4E`](https://docs.fivem.net/natives/?_0xDCF0754AC3D6FD4E)**
---
---```
...
---**`CAM` `client` [`0xDC9DA9E8789F5246`](https://docs.fivem.net/natives/?_0xDC9DA9E8789F5246)**
---
function SetCinematicNewsChannelActiveThisUpdate() end

---**`CAM` `client` [`0x0AF7B437918103B3`](https://docs.fivem.net/natives/?_0x0AF7B437918103B3)**
---
---@param distance number
function SetFirstPersonAimCamNearClipThisUpdate(distance) end

---**`CAM` `client` [`0x70894BD0915C5BCA`](https://docs.fivem.net/natives/?_0x70894BD0915C5BCA)**
---
---@param zoomFactor number
function SetFirstPersonAimCamZoomFactor(zoomFactor) end

---**`CAM` `client` [`0xC91C6C55199308CA`](https://docs.fivem.net/natives/?_0xC91C6C55199308CA)**
---
---@param cam Cam
---@param x number
---@param y number
...
---**`CAM` `client` [`0x503F5920162365B2`](https://docs.fivem.net/natives/?_0x503F5920162365B2)**
---
---@param cam Cam
---@param p1 number
---@param p2 number
...
---**`CAM` `client` [`0xF9D02130ECDD1D77`](https://docs.fivem.net/natives/?_0xF9D02130ECDD1D77)**
---
---@param cam Cam
---@param height number
function SetFlyCamMaxHeight(cam, height) end

---**`CAM` `client` [`0x44A113DD6FFC48D1`](https://docs.fivem.net/natives/?_0x44A113DD6FFC48D1)**
---
---```
---From the scripts:
...
---**`CAM` `client` [`0x5A4F9EDF1673F704`](https://docs.fivem.net/natives/?_0x5A4F9EDF1673F704)**
---
---See [`GET_FOLLOW_PED_CAM_VIEW_MODE`](#\_0x8D4D46230B2C353A) for the follow mode enum.
---
...
---**`CAM` `client` [`0xAC253D7842768F48`](https://docs.fivem.net/natives/?_0xAC253D7842768F48)**
---
---See [`GET_FOLLOW_PED_CAM_VIEW_MODE`](#\_0x8D4D46230B2C353A) for the follow mode enum.
---
---@param viewMode number
...
---**`CAM` `client` [`0x19464CB6E4078C8A`](https://docs.fivem.net/natives/?_0x19464CB6E4078C8A)**
---
---See [`GET_FOLLOW_PED_CAM_VIEW_MODE`](#\_0x8D4D46230B2C353A) for the follow mode enum.
---
...
---**`CAM` `client` [`0x8BBACBF51DA047A8`](https://docs.fivem.net/natives/?_0x8BBACBF51DA047A8)**
---
---@param ped Ped
...
---**`CAM` `client` [`0x6D0858B8EDFD2B7D`](https://docs.fivem.net/natives/?_0x6D0858B8EDFD2B7D)**
---
...
---**`CAM` `client` [`0xD51ADCD2D8BC0FB3`](https://docs.fivem.net/natives/?_0xD51ADCD2D8BC0FB3)**
---
---@param x number
---@param y number
---@param z number
...
---**`CAM` `client` [`0xD1F8363DFAD03848`](https://docs.fivem.net/natives/?_0xD1F8363DFAD03848)**
---
---@param value number
function SetGameplayHintBaseOrbitPitchOffset(value) end

---**`CAM` `client` [`0xF8BDBF3D573049A1`](https://docs.fivem.net/natives/?_0xF8BDBF3D573049A1)**
---
---@param value number
function SetGameplayHintFollowDistanceScalar(value) end

---**`CAM` `client` [`0x513403FB9C56211F`](https://docs.fivem.net/natives/?_0x513403FB9C56211F)**
---
---@param FOV number
function SetGameplayHintFov(FOV) end

---**`CAM` `client` [`0x83E87508A2CA2AC6`](https://docs.fivem.net/natives/?_0x83E87508A2CA2AC6)**
---
---@param p0 any
---@param p1 number
---@param p2 number
...
---**`CAM` `client` [`0x2B486269ACD548D3`](https://docs.fivem.net/natives/?_0x2B486269ACD548D3)**
---
---@param p0 Ped
---@param x1 number
---@param y1 number
...
---**`CAM` `client` [`0xA2297E18F3E71C2E`](https://docs.fivem.net/natives/?_0xA2297E18F3E71C2E)**
---
...
---**`CAM` `client` [`0xE9EA16D6E54CDCA4`](https://docs.fivem.net/natives/?_0xE9EA16D6E54CDCA4)**
---
---@param p0 Vehicle
---@param p1 number
...
---**`CAM` `client` [`0xDCD4EA924F42D01A`](https://docs.fivem.net/natives/?_0xDCD4EA924F42D01A)**
---
---@param p0 boolean
---@param p1 number
...
---**`CAM` `client` [`0xF4C8CF9E353AFECA`](https://docs.fivem.net/natives/?_0xF4C8CF9E353AFECA)**
---
---```
...
---**`CAM` `client` [`0xF33AB75780BA57DE`](https://docs.fivem.net/natives/?_0xF33AB75780BA57DE)**
---
---@param cam Cam
function StopCamPointing(cam) end

---**`CAM` `client` [`0xBDECF64367884AC3`](https://docs.fivem.net/natives/?_0xBDECF64367884AC3)**
---
---@param cam Cam
---@param p1 boolean
function StopCamShaking(cam, p1) end

---**`CAM` `client` [`0x2238E588E588A6D7`](https://docs.fivem.net/natives/?_0x2238E588E588A6D7)**
---
---@param p0 boolean
function StopCinematicCamShaking(p0) end

---**`CAM` `client` [`0x7660C6E75D3A078E`](https://docs.fivem.net/natives/?_0x7660C6E75D3A078E)**
---
---@param p0 Hash
function StopCinematicShot(p0) end

---**`CAM` `client` [`0xDB629FFD9285FA06`](https://docs.fivem.net/natives/?_0xDB629FFD9285FA06)**
---
...
---**`CAM` `client` [`0xC819F3CBB62BF692`](https://docs.fivem.net/natives/?_0xC819F3CBB62BF692)**
---
---```
...
---**`CAM` `client` [`0x1C9D7949FA533490`](https://docs.fivem.net/natives/?_0x1C9D7949FA533490)**
---
---```
---In drunk_controller.c4, sub_309
---if (CAM::IS_SCRIPT_GLOBAL_SHAKING()) {
...
---**`CAM` `client` [`0x149916F50C34A40D`](https://docs.fivem.net/natives/?_0x149916F50C34A40D)**
---
---```
---NativeDB Introduced: v1180
---```
...
---**`CAM` `client` [`0x8DB3F12A02CAEF72`](https://docs.fivem.net/natives/?_0x8DB3F12A02CAEF72)**
---
...
---**`CAM` `client` [`0x8F993D26E0CA5E8E`](https://docs.fivem.net/natives/?_0x8F993D26E0CA5E8E)**
---
---```
...
---**`CAM` `client` [`0x2AED6301F67007D5`](https://docs.fivem.net/natives/?_0x2AED6301F67007D5)**
---
---@param entity Entity
...
---**`CAM` `client` [`0xADFF1B2A555F5FBA`](https://docs.fivem.net/natives/?_0xADFF1B2A555F5FBA)**
---
...
---**`CAM` `client` [`0x19CAFA3C87F7C2FF`](https://docs.fivem.net/natives/?_0x19CAFA3C87F7C2FF)**
---
...
---**`CAM` `client` [`0x06D153C0B99B6128`](https://docs.fivem.net/natives/?_0x06D153C0B99B6128)**
---
---```
---NativeDB Introduced: v2699
---```
...
---**`CAM` `client` [`0xC2612D223D915A1C`](https://docs.fivem.net/natives/?_0xC2612D223D915A1C)**
---
---```
---NativeDB Introduced: v2699
---```
...
---**`CAM` `client` [`0x77C3CEC46BE286F6`](https://docs.fivem.net/natives/?_0x77C3CEC46BE286F6)**
---
---```
...
---**`CAM` `client` [`0x9E4CFFF989258472`](https://docs.fivem.net/natives/?_0x9E4CFFF989258472)**
---
...
---**`CAM` `client` [`0x74BD83EA840F6BC9`](https://docs.fivem.net/natives/?_0x74BD83EA840F6BC9)**
---
---```
---IS_A*
---```
...
---**`CAM` `client` [`0x4F32C0D5A90A9B40`](https://docs.fivem.net/natives/?_0x4F32C0D5A90A9B40)**
---
---@return boolean
function IsInVehicleCamDisabled() end

---**`CAM` `client` [`0x8BFCEB5EA1B161B6`](https://docs.fivem.net/natives/?_0x8BFCEB5EA1B161B6)**
---
---@return number
...
---**`CAM` `client` [`0x47B595D60664CFFA`](https://docs.fivem.net/natives/?_0x47B595D60664CFFA)**
---
---```
...
---**`CAM` `client` [`0xBCFC632DB7673BF0`](https://docs.fivem.net/natives/?_0xBCFC632DB7673BF0)**
---
---@param minAngle number
---@param maxAngle number
function SetFirstPersonCamPitchRange(minAngle, maxAngle) end

---**`CAM` `client` [`0xE827B9382CFB41BA`](https://docs.fivem.net/natives/?_0xE827B9382CFB41BA)**
---
---@param cam Cam
---@param p1 number
---@param p2 number
...
---**`CAM` `client` [`0x5C90CAB09951A12F`](https://docs.fivem.net/natives/?_0x5C90CAB09951A12F)**
---
---```
...
---**`CAM` `client` [`0x425A920FDB9A0DDA`](https://docs.fivem.net/natives/?_0x425A920FDB9A0DDA)**
---
---```
...
---**`CAM` `client` [`0x759E13EBC1C15C5A`](https://docs.fivem.net/natives/?_0x759E13EBC1C15C5A)**
---
---@param pitch number
...
---**`CAM` `client` [`0x48608C3464F58AB4`](https://docs.fivem.net/natives/?_0x48608C3464F58AB4)**
---
---@param roll number
---@param pitch number
---@param yaw number
...
---**`CAM` `client` [`0x21E253A7F8DA5DFB`](https://docs.fivem.net/natives/?_0x21E253A7F8DA5DFB)**
---
---```
---From b617 scripts:
...
---**`CAM` `client` [`0x11FA5D3479C7DD47`](https://docs.fivem.net/natives/?_0x11FA5D3479C7DD47)**
---
---@param vehicleModel Hash
function SetGameplayCamVehicleCameraName(vehicleModel) end

---**`CAM` `client` [`0xE3433EADAAF7EE40`](https://docs.fivem.net/natives/?_0xE3433EADAAF7EE40)**
---
---@param toggle boolean
function SetGameplayHintAnimCloseup(toggle) end

---**`CAM` `client` [`0x5D7B620DAE436138`](https://docs.fivem.net/natives/?_0x5D7B620DAE436138)**
---
---@param xOffset number
function SetGameplayHintAnimOffsetx(xOffset) end

---**`CAM` `client` [`0xC92717EF615B6704`](https://docs.fivem.net/natives/?_0xC92717EF615B6704)**
---
---@param yOffset number
function SetGameplayHintAnimOffsety(yOffset) end

---**`CAM` `client` [`0x731A880555DA3647`](https://docs.fivem.net/natives/?_0x731A880555DA3647)**
---
---```
...
---**`CAM` `client` [`0x6493CF69859B116A`](https://docs.fivem.net/natives/?_0x6493CF69859B116A)**
---
