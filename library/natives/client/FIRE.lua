---@meta
---**`FIRE` `client` [`0xE3AD2BDBAEE269AC`](https://docs.fivem.net/natives/?_0xE3AD2BDBAEE269AC)**
---
---```
...
---**`FIRE` `client` [`0x36DD3FE58B5E5212`](https://docs.fivem.net/natives/?_0x36DD3FE58B5E5212)**
---
---@param x number
---@param y number
---@param z number
...
---**`FIRE` `client` [`0x50CAD495A460B305`](https://docs.fivem.net/natives/?_0x50CAD495A460B305)**
---
---@param x number
---@param y number
---@param z number
...
---**`FIRE` `client` [`0x28D3FED7190D3A0B`](https://docs.fivem.net/natives/?_0x28D3FED7190D3A0B)**
---
---@param entity Entity
---@return boolean
function IsEntityOnFire(entity) end

---**`FIRE` `client` [`0x6070104B699B2EF4`](https://docs.fivem.net/natives/?_0x6070104B699B2EF4)**
---
---@param explosionType number See [`ADD_EXPLOSION`](#\_0xE3AD2BDBAEE269AC).
---@param x1 number
---@param y1 number
...
---**`FIRE` `client` [`0xA079A6C51525DC4B`](https://docs.fivem.net/natives/?_0xA079A6C51525DC4B)**
---
...
---**`FIRE` `client` [`0x2E2EBA0EE7CED0E0`](https://docs.fivem.net/natives/?_0x2E2EBA0EE7CED0E0)**
---
---@param explosionType number See [`ADD_EXPLOSION`](#\_0xE3AD2BDBAEE269AC).
---@param x1 number
---@param y1 number
...
---**`FIRE` `client` [`0xAB0F816885B0E483`](https://docs.fivem.net/natives/?_0xAB0F816885B0E483)**
---
---@param explosionType number See [`ADD_EXPLOSION`](#\_0xE3AD2BDBAEE269AC).
---@param x number
---@param y number
...
---**`FIRE` `client` [`0x7FF548385680673F`](https://docs.fivem.net/natives/?_0x7FF548385680673F)**
---
---@param fireHandle FireId
function RemoveScriptFire(fireHandle) end

---**`FIRE` `client` [`0xF6A9D9708F6F23DF`](https://docs.fivem.net/natives/?_0xF6A9D9708F6F23DF)**
---
---@param entity Entity
---@return FireId
...
---**`FIRE` `client` [`0x7F0DD2EBBB651AFF`](https://docs.fivem.net/natives/?_0x7F0DD2EBBB651AFF)**
---
---@param entity Entity
function StopEntityFire(entity) end

---**`FIRE` `client` [`0x056A8A219B8E829F`](https://docs.fivem.net/natives/?_0x056A8A219B8E829F)**
---
---@param x number
---@param y number
---@param z number
...
---**`FIRE` `client` [`0x14BA4BA137AF6CEC`](https://docs.fivem.net/natives/?_0x14BA4BA137AF6CEC)**
---
---```
...
---**`FIRE` `client` [`0xB3CD51E3DB86F176`](https://docs.fivem.net/natives/?_0xB3CD51E3DB86F176)**
---
---```
...
---**`FIRE` `client` [`0x8F390AC4155099BA`](https://docs.fivem.net/natives/?_0x8F390AC4155099BA)**
---
---SET_FIRE_\*
---
---```
