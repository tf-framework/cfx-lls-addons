---@meta
---**`OBJECT` `client` [`0x006E4B040ED37EC3`](https://docs.fivem.net/natives/?_0x006E4B040ED37EC3)**
---
---```
...
---**`OBJECT` `client` [`0x0596843B34B95CE5`](https://docs.fivem.net/natives/?_0x0596843B34B95CE5)**
---
---@param p0 any
---@param p1 any
function N_0x0596843b34b95ce5(p0, p1) end

---**`OBJECT` `client` [`0x1A6CBB06E2D0D79D`](https://docs.fivem.net/natives/?_0x1A6CBB06E2D0D79D)**
---
---```
...
---**`OBJECT` `client` [`0x1C57C94A6446492A`](https://docs.fivem.net/natives/?_0x1C57C94A6446492A)**
---
---```
---NativeDB Introduced: v1604
---```
...
---**`OBJECT` `client` [`0x1E3F1B1B891A2AAA`](https://docs.fivem.net/natives/?_0x1E3F1B1B891A2AAA)**
---
---@param p0 any
---@param p1 any
function N_0x1e3f1b1b891a2aaa(p0, p1) end

---**`OBJECT` `client` [`0x2542269291C6AC84`](https://docs.fivem.net/natives/?_0x2542269291C6AC84)**
---
---```
...
---**`OBJECT` `client` [`0x27F248C3FEBFAAD3`](https://docs.fivem.net/natives/?_0x27F248C3FEBFAAD3)**
---
---```
...
---**`OBJECT` `client` [`0x31574B1B41268673`](https://docs.fivem.net/natives/?_0x31574B1B41268673)**
---
---```
...
---**`OBJECT` `client` [`0x31F924B53EADDF65`](https://docs.fivem.net/natives/?_0x31F924B53EADDF65)**
---
---@param p0 boolean
function N_0x31f924b53eaddf65(p0) end

---**`OBJECT` `client` [`0x394CD08E31313C28`](https://docs.fivem.net/natives/?_0x394CD08E31313C28)**
---
function N_0x394cd08e31313c28() end

---**`OBJECT` `client` [`0x39A5FB7EAF150840`](https://docs.fivem.net/natives/?_0x39A5FB7EAF150840)**
---
---@param p0 any
---@param p1 any
function N_0x39a5fb7eaf150840(p0, p1) end

---**`OBJECT` `client` [`0x3B2FD68DB5F8331C`](https://docs.fivem.net/natives/?_0x3B2FD68DB5F8331C)**
---
---```
...
---**`OBJECT` `client` [`0x3BD770D281982DB5`](https://docs.fivem.net/natives/?_0x3BD770D281982DB5)**
---
---```
---NativeDB Introduced: v1604
---```
...
---**`OBJECT` `client` [`0x46F3ADD1E2D5BAF2`](https://docs.fivem.net/natives/?_0x46F3ADD1E2D5BAF2)**
---
---@param p0 any
---@param p1 any
function N_0x46f3add1e2d5baf2(p0, p1) end

---**`OBJECT` `client` [`0x4C134B4DF76025D0`](https://docs.fivem.net/natives/?_0x4C134B4DF76025D0)**
---
---```
---NativeDB Introduced: v1180
---```
...
---**`OBJECT` `client` [`0x62454A641B41F3C5`](https://docs.fivem.net/natives/?_0x62454A641B41F3C5)**
---
---@param p0 any
function N_0x62454a641b41f3c5(p0) end

---**`OBJECT` `client` [`0x63ECF581BC70E363`](https://docs.fivem.net/natives/?_0x63ECF581BC70E363)**
---
---```
...
---**`OBJECT` `client` [`0x641F272B52E2F0F8`](https://docs.fivem.net/natives/?_0x641F272B52E2F0F8)**
---
---@param p0 any
---@param p1 any
function N_0x641f272b52e2f0f8(p0, p1) end

---**`OBJECT` `client` [`0x659F9D71F52843F8`](https://docs.fivem.net/natives/?_0x659F9D71F52843F8)**
---
---```
...
---**`OBJECT` `client` [`0x66A49D021870FE88`](https://docs.fivem.net/natives/?_0x66A49D021870FE88)**
---
function N_0x66a49d021870fe88() end

---**`OBJECT` `client` [`0x701FDA1E82076BA4`](https://docs.fivem.net/natives/?_0x701FDA1E82076BA4)**
---
...
---**`OBJECT` `client` [`0x734E1714D077DA9A`](https://docs.fivem.net/natives/?_0x734E1714D077DA9A)**
---
---```
---NativeDB Introduced: v1604
---```
...
---**`OBJECT` `client` [`0x762DB2D380B48D04`](https://docs.fivem.net/natives/?_0x762DB2D380B48D04)**
---
---@param p0 any
function N_0x762db2d380b48d04(p0) end

---**`OBJECT` `client` [`0x7813E8B8C4AE4799`](https://docs.fivem.net/natives/?_0x7813E8B8C4AE4799)**
---
---SET_PICKUP_\*
---
---```
...
---**`OBJECT` `client` [`0x826D1EE4D1CAFC78`](https://docs.fivem.net/natives/?_0x826D1EE4D1CAFC78)**
---
---@param p0 any
---@param p1 any
function N_0x826d1ee4d1cafc78(p0, p1) end

---**`OBJECT` `client` [`0x834344A414C7C85D`](https://docs.fivem.net/natives/?_0x834344A414C7C85D)**
---
---```
---NativeDB Introduced: v2372
---```
...
---**`OBJECT` `client` [`0x858EC9FD25DE04AA`](https://docs.fivem.net/natives/?_0x858EC9FD25DE04AA)**
---
---@param p0 any
---@param p1 any
function N_0x858ec9fd25de04aa(p0, p1) end

---**`OBJECT` `client` [`0x8881C98A31117998`](https://docs.fivem.net/natives/?_0x8881C98A31117998)**
---
---```
...
---**`OBJECT` `client` [`0x8CAAB2BD3EA58BD4`](https://docs.fivem.net/natives/?_0x8CAAB2BD3EA58BD4)**
---
---@param p0 any
function N_0x8caab2bd3ea58bd4(p0) end

---**`OBJECT` `client` [`0x8CFF648FBD7330F1`](https://docs.fivem.net/natives/?_0x8CFF648FBD7330F1)**
---
---```
---NativeDB Introduced: v757
---```
...
---**`OBJECT` `client` [`0x8DCA505A5C196F05`](https://docs.fivem.net/natives/?_0x8DCA505A5C196F05)**
---
---```
---NativeDB Introduced: v1180
---```
...
---**`OBJECT` `client` [`0xA08FE5E49BDC39DD`](https://docs.fivem.net/natives/?_0xA08FE5E49BDC39DD)**
---
---@param p0 any
---@param p1 number
---@param p2 boolean
...
---**`OBJECT` `client` [`0xA2C1F5E92AFE49ED`](https://docs.fivem.net/natives/?_0xA2C1F5E92AFE49ED)**
---
---```
---CLEAR_*
---```
...
---**`OBJECT` `client` [`0xA85A21582451E951`](https://docs.fivem.net/natives/?_0xA85A21582451E951)**
---
...
---**`OBJECT` `client` [`0xAA059C615DE9DD03`](https://docs.fivem.net/natives/?_0xAA059C615DE9DD03)**
---
---```
---NativeDB Introduced: v1180
---```
...
---**`OBJECT` `client` [`0xADF084FB8F075D06`](https://docs.fivem.net/natives/?_0xADF084FB8F075D06)**
---
---```
---NativeDB Introduced: v1604
---```
...
---**`OBJECT` `client` [`0xAFE24E4D29249E4A`](https://docs.fivem.net/natives/?_0xAFE24E4D29249E4A)**
---
---```
---NativeDB Introduced: v1734
---```
...
---**`OBJECT` `client` [`0xB2D0BDE54F0E8E5A`](https://docs.fivem.net/natives/?_0xB2D0BDE54F0E8E5A)**
---
---@param object Object
---@param toggle boolean
function N_0xb2d0bde54f0e8e5a(object, toggle) end

---**`OBJECT` `client` [`0xB5B7742424BD4445`](https://docs.fivem.net/natives/?_0xB5B7742424BD4445)**
---
---```
---NativeDB Introduced: v1604
---```
...
---**`OBJECT` `client` [`0xB7C6D80FB371659A`](https://docs.fivem.net/natives/?_0xB7C6D80FB371659A)**
---
---```
...
---**`OBJECT` `client` [`0xBFFE53AE7E67FCDC`](https://docs.fivem.net/natives/?_0xBFFE53AE7E67FCDC)**
---
---```
---NativeDB Introduced: v1290
---```
...
---**`OBJECT` `client` [`0xC6033D32241F6FB5`](https://docs.fivem.net/natives/?_0xC6033D32241F6FB5)**
---
---@param object Object
---@param toggle boolean
function N_0xc6033d32241f6fb5(object, toggle) end

---**`OBJECT` `client` [`0xC7F29CA00F46350E`](https://docs.fivem.net/natives/?_0xC7F29CA00F46350E)**
---
...
---**`OBJECT` `client` [`0xD05A3241B9A86F19`](https://docs.fivem.net/natives/?_0xD05A3241B9A86F19)**
---
---```
---NativeDB Introduced: v1180
---```
...
---**`OBJECT` `client` [`0xD4A7A435B3710D05`](https://docs.fivem.net/natives/?_0xD4A7A435B3710D05)**
---
---```
...
---**`OBJECT` `client` [`0xDB41D07A45A6D4B7`](https://docs.fivem.net/natives/?_0xDB41D07A45A6D4B7)**
---
---@param p0 any
---@return any
function N_0xdb41d07a45a6d4b7(p0) end

---**`OBJECT` `client` [`0xE05F6AEEFEB0BB02`](https://docs.fivem.net/natives/?_0xE05F6AEEFEB0BB02)**
---
---```
---NativeDB Introduced: v1180
---```
...
---**`OBJECT` `client` [`0xEB6F1A9B5510A5D2`](https://docs.fivem.net/natives/?_0xEB6F1A9B5510A5D2)**
---
---@param p0 any
---@param p1 boolean
function N_0xeb6f1a9b5510a5d2(p0, p1) end

---**`OBJECT` `client` [`0xF92099527DB8E2A7`](https://docs.fivem.net/natives/?_0xF92099527DB8E2A7)**
---
---@param p0 any
---@param p1 any
function N_0xf92099527db8e2a7(p0, p1) end

---**`OBJECT` `client` [`0xFDC07C58E8AAB715`](https://docs.fivem.net/natives/?_0xFDC07C58E8AAB715)**
---
---A\*
---
---```
...
---**`OBJECT` `client` [`0x6F8838D03D1DC226`](https://docs.fivem.net/natives/?_0x6F8838D03D1DC226)**
---
...
---**`OBJECT` `client` [`0x85B6C850546FDDE2`](https://docs.fivem.net/natives/?_0x85B6C850546FDDE2)**
---
...
---**`OBJECT` `client` [`0x8DC39368BDD57755`](https://docs.fivem.net/natives/?_0x8DC39368BDD57755)**
---
---@param pickupObject Object
---@param ped Ped
function AttachPortablePickupToPed(pickupObject, ped) end

---**`OBJECT` `client` [`0xE7E4C198B0185900`](https://docs.fivem.net/natives/?_0xE7E4C198B0185900)**
---
---@param p0 Object
---@param p1 any
---@param p2 boolean
...
---**`OBJECT` `client` [`0x190428512B240692`](https://docs.fivem.net/natives/?_0x190428512B240692)**
---
---@param garageHash Hash
...
---**`OBJECT` `client` [`0x673966A0C0FD7171`](https://docs.fivem.net/natives/?_0x673966A0C0FD7171)**
---
...
---**`OBJECT` `client` [`0x0589B5E791CE9B2B`](https://docs.fivem.net/natives/?_0x0589B5E791CE9B2B)**
---
---```
...
---**`OBJECT` `client` [`0x125494B98A21AAF7`](https://docs.fivem.net/natives/?_0x125494B98A21AAF7)**
---
---@param pickupHash Hash
---@param x number
---@param y number
...
---**`OBJECT` `client` [`0x509D5878EB39E842`](https://docs.fivem.net/natives/?_0x509D5878EB39E842)**
---
...
---**`OBJECT` `client` [`0x9A294B2138ABB884`](https://docs.fivem.net/natives/?_0x9A294B2138ABB884)**
---
...
---**`OBJECT` `client` [`0xFBA08C503DD5FA58`](https://docs.fivem.net/natives/?_0xFBA08C503DD5FA58)**
---
...
---**`OBJECT` `client` [`0x891804727E0A98B7`](https://docs.fivem.net/natives/?_0x891804727E0A98B7)**
---
---```
...
---**`OBJECT` `client` [`0x2EAF1FDB2FB55698`](https://docs.fivem.net/natives/?_0x2EAF1FDB2FB55698)**
---
---Pickup hashes can be found [here](https://gist.github.com/4mmonium/1eabfb6b3996e3aa6b9525a3eccf8a0b).
---
---@param pickupHash Hash
...
---**`OBJECT` `client` [`0x539E0AE3E6634B9F`](https://docs.fivem.net/natives/?_0x539E0AE3E6634B9F)**
---
---```
...
---**`OBJECT` `client` [`0xCF463D1E9A0AECB1`](https://docs.fivem.net/natives/?_0xCF463D1E9A0AECB1)**
---
---@param pickupObject Object
function DetachPortablePickupFromPed(pickupObject) end

---**`OBJECT` `client` [`0xBFA48E2FF417213F`](https://docs.fivem.net/natives/?_0xBFA48E2FF417213F)**
---
---```
---p5 is usually 0.  
---```
...
---**`OBJECT` `client` [`0xAFC1CA75AD4074D1`](https://docs.fivem.net/natives/?_0xAFC1CA75AD4074D1)**
---
---@param pickup Pickup
---@return boolean
function DoesPickupExist(pickup) end

---**`OBJECT` `client` [`0xD9EFB6DBF7DAAEA3`](https://docs.fivem.net/natives/?_0xD9EFB6DBF7DAAEA3)**
---
---@param pickupObject Object
---@return boolean
function DoesPickupObjectExist(pickupObject) end

---**`OBJECT` `client` [`0xF9C36251F6E48E33`](https://docs.fivem.net/natives/?_0xF9C36251F6E48E33)**
---
---Pickup hashes can be found [here](https://gist.github.com/4mmonium/1eabfb6b3996e3aa6b9525a3eccf8a0b).
---
---@param pickupHash Hash
...
---**`OBJECT` `client` [`0x52AF537A0C5B8AAD`](https://docs.fivem.net/natives/?_0x52AF537A0C5B8AAD)**
---
---```
...
---**`OBJECT` `client` [`0x589F80B325CC82C5`](https://docs.fivem.net/natives/?_0x589F80B325CC82C5)**
---
---Search radius: 0.5
---
---@param x number The X coordinate of the door object
...
---**`OBJECT` `client` [`0x4BC2854478F3A749`](https://docs.fivem.net/natives/?_0x4BC2854478F3A749)**
---
---@param doorHash Hash
---@return number
function DoorSystemGetDoorPendingState(doorHash) end

---**`OBJECT` `client` [`0x160AA1B32F6139B8`](https://docs.fivem.net/natives/?_0x160AA1B32F6139B8)**
---
---@param doorHash Hash
---@return number
function DoorSystemGetDoorState(doorHash) end

---**`OBJECT` `client` [`0xDF97CDD4FC08FD34`](https://docs.fivem.net/natives/?_0xDF97CDD4FC08FD34)**
---
---@param doorHash Hash
---@return boolean
function DoorSystemGetIsPhysicsLoaded(doorHash) end

---**`OBJECT` `client` [`0x65499865FCA6E5EC`](https://docs.fivem.net/natives/?_0x65499865FCA6E5EC)**
---
---@param doorHash Hash
---@return number
function DoorSystemGetOpenRatio(doorHash) end

---**`OBJECT` `client` [`0x9BA001CB45CBF627`](https://docs.fivem.net/natives/?_0x9BA001CB45CBF627)**
---
...
---**`OBJECT` `client` [`0x03C27E13B42A0E82`](https://docs.fivem.net/natives/?_0x03C27E13B42A0E82)**
---
...
---**`OBJECT` `client` [`0x6BAB9442830C7F53`](https://docs.fivem.net/natives/?_0x6BAB9442830C7F53)**
---
...
---**`OBJECT` `client` [`0xD9B71952F78A2640`](https://docs.fivem.net/natives/?_0xD9B71952F78A2640)**
---
---Includes networking check: ownership vs. or the door itself **isn't** networked.
---
---@param doorHash Hash Door system identifier
...
---**`OBJECT` `client` [`0xB6E6FBA95C7324AC`](https://docs.fivem.net/natives/?_0xB6E6FBA95C7324AC)**
---
---```
...
---**`OBJECT` `client` [`0xC485E07E4F0B7958`](https://docs.fivem.net/natives/?_0xC485E07E4F0B7958)**
---
---Includes networking check: ownership vs. or the door itself **isn't** networked.
---
---@param doorHash Hash Door system identifier
...
---**`OBJECT` `client` [`0xF2E1A7133DD356A6`](https://docs.fivem.net/natives/?_0xF2E1A7133DD356A6)**
---
---@param garageHash Hash
---@param toggle boolean
function EnableSavingInGarage(garageHash, toggle) end

---**`OBJECT` `client` [`0xF9C1681347C8BD15`](https://docs.fivem.net/natives/?_0xF9C1681347C8BD15)**
---
...
---**`OBJECT` `client` [`0xE143FA2249364369`](https://docs.fivem.net/natives/?_0xE143FA2249364369)**
---
---```
...
---**`OBJECT` `client` [`0x163F8B586BC95F2A`](https://docs.fivem.net/natives/?_0x163F8B586BC95F2A)**
---
---@param x number
---@param y number
---@param z number
...
---**`OBJECT` `client` [`0xB6FBFD079B8D0596`](https://docs.fivem.net/natives/?_0xB6FBFD079B8D0596)**
---
---@param p0 any
---@param p1 boolean
---@return number
...
---**`OBJECT` `client` [`0x5099BC55630B25AE`](https://docs.fivem.net/natives/?_0x5099BC55630B25AE)**
---
---@param pickup Pickup
---@return Object
function GetPickupObject(pickup) end

---**`OBJECT` `client` [`0xB48FCED898292E52`](https://docs.fivem.net/natives/?_0xB48FCED898292E52)**
---
---```
---Example:
...
---**`OBJECT` `client` [`0x260EE4FDBDF4DB01`](https://docs.fivem.net/natives/?_0x260EE4FDBDF4DB01)**
---
---```
...
---**`OBJECT` `client` [`0x6E16BC2503FF1FF0`](https://docs.fivem.net/natives/?_0x6E16BC2503FF1FF0)**
---
---@param x number
---@param y number
---@param z number
...
---**`OBJECT` `client` [`0xEDC1A5B84AEF33FF`](https://docs.fivem.net/natives/?_0xEDC1A5B84AEF33FF)**
---
---```
...
---**`OBJECT` `client` [`0x899BA936634A322E`](https://docs.fivem.net/natives/?_0x899BA936634A322E)**
---
...
---**`OBJECT` `client` [`0x08F96CA6C551AD51`](https://docs.fivem.net/natives/?_0x08F96CA6C551AD51)**
---
---@param pickupHash Hash
---@return Hash
function GetWeaponTypeFromPickupType(pickupHash) end

---**`OBJECT` `client` [`0x761B0E69AC4D007E`](https://docs.fivem.net/natives/?_0x761B0E69AC4D007E)**
---
---@param p0 number
---@param p1 number
---@param p2 number
...
---**`OBJECT` `client` [`0x46494A2475701343`](https://docs.fivem.net/natives/?_0x46494A2475701343)**
---
---@param x number
---@param y number
---@param z number
...
---**`OBJECT` `client` [`0x8ABFB70C49CC43E2`](https://docs.fivem.net/natives/?_0x8ABFB70C49CC43E2)**
---
---```
---NativeDB Added Parameter 2: Any p1
---```
...
---**`OBJECT` `client` [`0x80EC48E6679313F9`](https://docs.fivem.net/natives/?_0x80EC48E6679313F9)**
---
---@param pickup Pickup
---@return boolean
function HasPickupBeenCollected(pickup) end

---**`OBJECT` `client` [`0x867458251D47CCB2`](https://docs.fivem.net/natives/?_0x867458251D47CCB2)**
---
---@param pickup Pickup
---@param toggle boolean
function HidePortablePickupWhenDetached(pickup, toggle) end

---**`OBJECT` `client` [`0x673ED815D6E323B7`](https://docs.fivem.net/natives/?_0x673ED815D6E323B7)**
---
---@param garageHash Hash
---@param p1 boolean
---@param p2 boolean
...
---**`OBJECT` `client` [`0x397DC58FF00298D1`](https://docs.fivem.net/natives/?_0x397DC58FF00298D1)**
---
---@param x number
---@param y number
---@param z number
...
---**`OBJECT` `client` [`0xC531EE8A1145A149`](https://docs.fivem.net/natives/?_0xC531EE8A1145A149)**
---
---@param doorHash Hash
---@return boolean
function IsDoorClosed(doorHash) end

---**`OBJECT` `client` [`0xC153C43EA202C8C1`](https://docs.fivem.net/natives/?_0xC153C43EA202C8C1)**
---
---```
...
---**`OBJECT` `client` [`0x90E47239EA1980B8`](https://docs.fivem.net/natives/?_0x90E47239EA1980B8)**
---
---@param garageHash Hash
---@param p1 boolean
---@param p2 number
...
---**`OBJECT` `client` [`0xFC481C641EBBD27D`](https://docs.fivem.net/natives/?_0xFC481C641EBBD27D)**
---
---@param object Object
---@return boolean
function IsObjectAPickup(object) end

---**`OBJECT` `client` [`0x0378C08504160D0D`](https://docs.fivem.net/natives/?_0x0378C08504160D0D)**
---
---```
---NativeDB Introduced: v1365
---```
...
---**`OBJECT` `client` [`0x372EF6699146A1E4`](https://docs.fivem.net/natives/?_0x372EF6699146A1E4)**
---
---@param garageHash Hash
---@param entity Entity
---@param p2 number
...
---**`OBJECT` `client` [`0x8C90FE4B381BA60A`](https://docs.fivem.net/natives/?_0x8C90FE4B381BA60A)**
---
...
---**`OBJECT` `client` [`0xF0EED5A6BC7B237A`](https://docs.fivem.net/natives/?_0xF0EED5A6BC7B237A)**
---
---@param garageHash Hash
---@param entity Entity
---@param p2 number
...
---**`OBJECT` `client` [`0x8B32ACE6326A7546`](https://docs.fivem.net/natives/?_0x8B32ACE6326A7546)**
---
---@param object Object
---@return boolean
function IsObjectVisible(object) end

---**`OBJECT` `client` [`0x11D1E53A726891FE`](https://docs.fivem.net/natives/?_0x11D1E53A726891FE)**
---
---@param object Object
---@return boolean
function IsPickupWeaponObjectValid(object) end

---**`OBJECT` `client` [`0x024A60DEB0EA69F0`](https://docs.fivem.net/natives/?_0x024A60DEB0EA69F0)**
---
---@param garageHash Hash
---@param player Player
---@param p2 number
...
---**`OBJECT` `client` [`0x1761DC5D8471CBAA`](https://docs.fivem.net/natives/?_0x1761DC5D8471CBAA)**
---
---@param garageHash Hash
---@param player Player
---@param p2 number
...
---**`OBJECT` `client` [`0x2A70BAE8883E4C81`](https://docs.fivem.net/natives/?_0x2A70BAE8883E4C81)**
---
...
---**`OBJECT` `client` [`0x58A850EAEE20FAA3`](https://docs.fivem.net/natives/?_0x58A850EAEE20FAA3)**
---
---@param object Object
---@return boolean
function PlaceObjectOnGroundProperly(object) end

---**`OBJECT` `client` [`0x92AEFB5F6E294023`](https://docs.fivem.net/natives/?_0x92AEFB5F6E294023)**
---
---@param object Object
---@param p1 boolean
---@param p2 boolean
...
---**`OBJECT` `client` [`0x27F9D613092159CF`](https://docs.fivem.net/natives/?_0x27F9D613092159CF)**
---
---Pickup hashes can be found [here](https://gist.github.com/4mmonium/1eabfb6b3996e3aa6b9525a3eccf8a0b).
---
---@param pickupHash Hash
...
---**`OBJECT` `client` [`0x464D8E1427156FE4`](https://docs.fivem.net/natives/?_0x464D8E1427156FE4)**
---
...
---**`OBJECT` `client` [`0x4A39DB43E47CF3AA`](https://docs.fivem.net/natives/?_0x4A39DB43E47CF3AA)**
---
---@param object Object
function RemoveObjectHighDetailModel(object) end

---**`OBJECT` `client` [`0x3288D8ACAECD2AB2`](https://docs.fivem.net/natives/?_0x3288D8ACAECD2AB2)**
---
---@param pickup Pickup
function RemovePickup(pickup) end

---**`OBJECT` `client` [`0x3430676B11CDF21D`](https://docs.fivem.net/natives/?_0x3430676B11CDF21D)**
---
---```
...
---**`OBJECT` `client` [`0x406137F8EF90EAF5`](https://docs.fivem.net/natives/?_0x406137F8EF90EAF5)**
---
---@param object Object
---@param toggle boolean
function SetActivateObjectPhysicsAsSoonAsItIsUnfrozen(object, toggle) end

---**`OBJECT` `client` [`0xF538081986E49E9D`](https://docs.fivem.net/natives/?_0xF538081986E49E9D)**
---
---@param x number
---@param y number
---@param z number
...
---**`OBJECT` `client` [`0x78857FC65CADB909`](https://docs.fivem.net/natives/?_0x78857FC65CADB909)**
---
---@param p0 boolean
function SetLocalPlayerCanCollectPortablePickups(p0) end

---**`OBJECT` `client` [`0x0BF3B3BD47D79C08`](https://docs.fivem.net/natives/?_0x0BF3B3BD47D79C08)**
---
---@param modelHash Hash
---@param p1 number
function SetMaxNumPortablePickupsCarriedByPlayer(modelHash, p1) end

---**`OBJECT` `client` [`0x4D89D607CB3DD1D2`](https://docs.fivem.net/natives/?_0x4D89D607CB3DD1D2)**
---
---```
...
---**`OBJECT` `client` [`0x77F33F2CCF64B3AA`](https://docs.fivem.net/natives/?_0x77F33F2CCF64B3AA)**
---
...
---**`OBJECT` `client` [`0xF6DF6E90DE7DF90F`](https://docs.fivem.net/natives/?_0xF6DF6E90DE7DF90F)**
---
---```
...
---**`OBJECT` `client` [`0x8A7391690F5AFD81`](https://docs.fivem.net/natives/?_0x8A7391690F5AFD81)**
---
---@param object Object
---@param targettable boolean
function SetObjectTargettable(object, targettable) end

---**`OBJECT` `client` [`0x318516E02DE3ECE2`](https://docs.fivem.net/natives/?_0x318516E02DE3ECE2)**
---
---@param multiplier number
function SetPickupGenerationRangeMultiplier(multiplier) end

---**`OBJECT` `client` [`0x78015C9B4B3ECC9D`](https://docs.fivem.net/natives/?_0x78015C9B4B3ECC9D)**
---
---@param pickup Pickup
---@param duration number
function SetPickupRegenerationTime(pickup, duration) end

---**`OBJECT` `client` [`0xF82D8F1926A02C3D`](https://docs.fivem.net/natives/?_0xF82D8F1926A02C3D)**
---
---```
...
---**`OBJECT` `client` [`0x5C29F698D404C5E1`](https://docs.fivem.net/natives/?_0x5C29F698D404C5E1)**
---
---```
...
---**`OBJECT` `client` [`0x53E0DF1A2A3CF0CA`](https://docs.fivem.net/natives/?_0x53E0DF1A2A3CF0CA)**
---
---@param object Object
---@param p1 any
---@param p2 boolean
...
---**`OBJECT` `client` [`0x2FDFF4107B8C1147`](https://docs.fivem.net/natives/?_0x2FDFF4107B8C1147)**
---
---```
...
---**`OBJECT` `client` [`0xB252BC036B525623`](https://docs.fivem.net/natives/?_0xB252BC036B525623)**
---
---@param object Object
function TrackObjectVisibility(object) end

---**`OBJECT` `client` [`0xDA05194260CDCDF9`](https://docs.fivem.net/natives/?_0xDA05194260CDCDF9)**
---
---@param garageHash Hash
---@param isNetwork boolean
function ClearGarageArea(garageHash, isNetwork) end

---**`OBJECT` `client` [`0x9C93764223E29C50`](https://docs.fivem.net/natives/?_0x9C93764223E29C50)**
---
---```
---NativeDB Introduced: v2372
---```
...
---**`OBJECT` `client` [`0x9B12F9A24FABEDB0`](https://docs.fivem.net/natives/?_0x9B12F9A24FABEDB0)**
---
...
---**`OBJECT` `client` [`0xE851471AEFC3374F`](https://docs.fivem.net/natives/?_0xE851471AEFC3374F)**
---
---```
---NativeDB Introduced: v1868
---```
...
---**`OBJECT` `client` [`0x758A5C1B3B1E1990`](https://docs.fivem.net/natives/?_0x758A5C1B3B1E1990)**
---
---@param p0 any
function ForcePickupRegenerate(p0) end

---**`OBJECT` `client` [`0x43C677F1E1158005`](https://docs.fivem.net/natives/?_0x43C677F1E1158005)**
---
---```
---NativeDB Introduced: v1604
---```
...
---**`OBJECT` `client` [`0xB3ECA65C7317F174`](https://docs.fivem.net/natives/?_0xB3ECA65C7317F174)**
---
---@return number
function GetPickupGenerationRangeMultiplier() end

---**`OBJECT` `client` [`0x5EAAD83F8CFB4575`](https://docs.fivem.net/natives/?_0x5EAAD83F8CFB4575)**
---
---```
---returns pickup hash.
---```
...
---**`OBJECT` `client` [`0xD6429A016084F1A5`](https://docs.fivem.net/natives/?_0xD6429A016084F1A5)**
---
---```
---NativeDB Introduced: v1290
---```
...
---**`OBJECT` `client` [`0xADBE4809F19F927A`](https://docs.fivem.net/natives/?_0xADBE4809F19F927A)**
---
---```
...
---**`OBJECT` `client` [`0xD76EEEF746057FD6`](https://docs.fivem.net/natives/?_0xD76EEEF746057FD6)**
---
---@param object Object
---@return boolean
function PlaceObjectOnGroundProperly_2(object) end

---**`OBJECT` `client` [`0xBCE595371A5FBAAF`](https://docs.fivem.net/natives/?_0xBCE595371A5FBAAF)**
---
---```
...
---**`OBJECT` `client` [`0x911024442F4898F0`](https://docs.fivem.net/natives/?_0x911024442F4898F0)**
---
---```
...
---**`OBJECT` `client` [`0xB20834A7DD3D8896`](https://docs.fivem.net/natives/?_0xB20834A7DD3D8896)**
---
---```
---NativeDB Introduced: v1604
---```
...
---**`OBJECT` `client` [`0x88EAEC617CD26926`](https://docs.fivem.net/natives/?_0x88EAEC617CD26926)**
---
---```
...
---**`OBJECT` `client` [`0x5F048334B4A4E774`](https://docs.fivem.net/natives/?_0x5F048334B4A4E774)**
---
...
---**`OBJECT` `client` [`0xDF6CA0330F2E737B`](https://docs.fivem.net/natives/?_0xDF6CA0330F2E737B)**
---
---@param object Object
---@param duration number
function SetObjectStuntPropDuration(object, duration) end

---**`OBJECT` `client` [`0x96EE0EBA0163DF80`](https://docs.fivem.net/natives/?_0x96EE0EBA0163DF80)**
---
...
---**`OBJECT` `client` [`0x971DA0055324D033`](https://docs.fivem.net/natives/?_0x971DA0055324D033)**
---
---```
...
---**`OBJECT` `client` [`0x3ED2B83AB2E82799`](https://docs.fivem.net/natives/?_0x3ED2B83AB2E82799)**
---
---@param p0 any
---@param p1 any
function SetPickupHiddenWhenUncollectable(p0, p1) end

---**`OBJECT` `client` [`0x1C1B69FAE509BA97`](https://docs.fivem.net/natives/?_0x1C1B69FAE509BA97)**
---
---@param p0 any
---@param p1 any
function SetPickupUncollectable(p0, p1) end

---**`OBJECT` `client` [`0xF12E33034D887F66`](https://docs.fivem.net/natives/?_0xF12E33034D887F66)**
---
---@param x number
---@param y number
---@param z number
...
---**`OBJECT` `client` [`0xABDABF4E1EDECBFA`](https://docs.fivem.net/natives/?_0xABDABF4E1EDECBFA)**
---
---```
---NativeDB Introduced: v1365
---```
...
---**`OBJECT` `client` [`0x616093EC6B139DD9`](https://docs.fivem.net/natives/?_0x616093EC6B139DD9)**
---
---```
