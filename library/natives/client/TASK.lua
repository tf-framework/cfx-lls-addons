...
---@param bDisableIdleAnims boolean If true, prevents a ped from playing an idle animation this frame.
---@param bStopCurrentAnim boolean If true and the ped is playing an idle animation, the clip is stopped.
...
---@param fCruiseSpeed number The speed of the plane (in m/s).
---@param fTargetReachedDist number Distance (in meters) at which the plane thinks it has arrived to the given coordinates.
