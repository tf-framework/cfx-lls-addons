---@meta
---**`HUD` `client` [`0x04655F9D075D0AE5`](https://docs.fivem.net/natives/?_0x04655F9D075D0AE5)**
---
---```
---SET_*
---```
...
---**`HUD` `client` [`0x0C698D8F099174C7`](https://docs.fivem.net/natives/?_0x0C698D8F099174C7)**
---
---```
...
---**`HUD` `client` [`0x0CF54F20DE43879C`](https://docs.fivem.net/natives/?_0x0CF54F20DE43879C)**
---
---@param p0 any
...
---**`HUD` `client` [`0x211C4EF450086857`](https://docs.fivem.net/natives/?_0x211C4EF450086857)**
---
---**This native does absolutely nothing, just a nullsub**
---
function N_0x211c4ef450086857() end

---**`HUD` `client` [`0x214CD562A939246A`](https://docs.fivem.net/natives/?_0x214CD562A939246A)**
---
---```
---HAS_S*
---```
...
---**`HUD` `client` [`0x243296A510B562B6`](https://docs.fivem.net/natives/?_0x243296A510B562B6)**
---
---```
...
---**`HUD` `client` [`0x24A49BEAF468DC90`](https://docs.fivem.net/natives/?_0x24A49BEAF468DC90)**
---
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`HUD` `client` [`0x2790F4B17D098E26`](https://docs.fivem.net/natives/?_0x2790F4B17D098E26)**
---
---```
---SET_F*
---```
...
---**`HUD` `client` [`0x2C9F302398E13141`](https://docs.fivem.net/natives/?_0x2C9F302398E13141)**
---
...
---**`HUD` `client` [`0x35A3CD97B2C0A6D2`](https://docs.fivem.net/natives/?_0x35A3CD97B2C0A6D2)**
---
---```
...
---**`HUD` `client` [`0x41350B4FC28E3941`](https://docs.fivem.net/natives/?_0x41350B4FC28E3941)**
---
---@param p0 boolean
function N_0x41350b4fc28e3941(p0) end

---**`HUD` `client` [`0x4B5B620C9B59ED34`](https://docs.fivem.net/natives/?_0x4B5B620C9B59ED34)**
---
---@param p0 any
---@param p1 any
function N_0x4b5b620c9b59ed34(p0, p1) end

---**`HUD` `client` [`0x55F5A5F07134DE60`](https://docs.fivem.net/natives/?_0x55F5A5F07134DE60)**
---
---```
---NativeDB Introduced: v1180
---```
...
---**`HUD` `client` [`0x577599CCED639CA2`](https://docs.fivem.net/natives/?_0x577599CCED639CA2)**
---
---@param p0 any
function N_0x577599cced639ca2(p0) end

---**`HUD` `client` [`0x57D760D55F54E071`](https://docs.fivem.net/natives/?_0x57D760D55F54E071)**
---
---```
---FORCE_*
---```
...
---**`HUD` `client` [`0x593FEAE1F73392D4`](https://docs.fivem.net/natives/?_0x593FEAE1F73392D4)**
---
---@return any
function N_0x593feae1f73392d4() end

---**`HUD` `client` [`0x62E849B7EB28E770`](https://docs.fivem.net/natives/?_0x62E849B7EB28E770)**
---
---@param p0 boolean
function N_0x62e849b7eb28e770(p0) end

---**`HUD` `client` [`0x66E7CB63C97B7D20`](https://docs.fivem.net/natives/?_0x66E7CB63C97B7D20)**
---
---@return any
function N_0x66e7cb63c97b7d20() end

---**`HUD` `client` [`0x7C226D5346D4D10A`](https://docs.fivem.net/natives/?_0x7C226D5346D4D10A)**
---
---@param p0 any
function N_0x7c226d5346d4d10a(p0) end

---**`HUD` `client` [`0x801879A9B4F4B2FB`](https://docs.fivem.net/natives/?_0x801879A9B4F4B2FB)**
---
---```
---IS_*
---```
...
---**`HUD` `client` [`0x8410C5E0CD847B9D`](https://docs.fivem.net/natives/?_0x8410C5E0CD847B9D)**
---
---```
---NativeDB Introduced: v1290
---```
...
---**`HUD` `client` [`0x8F08017F9D7C47BD`](https://docs.fivem.net/natives/?_0x8F08017F9D7C47BD)**
---
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`HUD` `client` [`0x98C3CF913D895111`](https://docs.fivem.net/natives/?_0x98C3CF913D895111)**
---
---```
---GET_F*
---```
...
---**`HUD` `client` [`0x9FCB3CBFB3EAD69A`](https://docs.fivem.net/natives/?_0x9FCB3CBFB3EAD69A)**
---
---SET_C\*
---
---```
...
---**`HUD` `client` [`0xA17784FCA9548D15`](https://docs.fivem.net/natives/?_0xA17784FCA9548D15)**
---
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`HUD` `client` [`0xA238192F33110615`](https://docs.fivem.net/natives/?_0xA238192F33110615)**
---
---@param p0 number
---@param p1 number
---@param p2 number
...
---**`HUD` `client` [`0xB552929B85FC27EC`](https://docs.fivem.net/natives/?_0xB552929B85FC27EC)**
---
---@param p0 any
---@param p1 any
function N_0xb552929b85fc27ec(p0, p1) end

---**`HUD` `client` [`0xB7B873520C84C118`](https://docs.fivem.net/natives/?_0xB7B873520C84C118)**
---
---SET_C\*
---
---```
...
---**`HUD` `client` [`0xBA8D65C1C65702E5`](https://docs.fivem.net/natives/?_0xBA8D65C1C65702E5)**
---
---```
---FORCE_*
---```
...
---**`HUD` `client` [`0xBF4F34A85CA2970C`](https://docs.fivem.net/natives/?_0xBF4F34A85CA2970C)**
---
function N_0xbf4f34a85ca2970c() end

---**`HUD` `client` [`0xC2D2AD9EAAE265B8`](https://docs.fivem.net/natives/?_0xC2D2AD9EAAE265B8)**
---
---```
...
---**`HUD` `client` [`0xC594B315EDF2D4AF`](https://docs.fivem.net/natives/?_0xC594B315EDF2D4AF)**
---
---@param ped Ped
function N_0xc594b315edf2d4af(ped) end

---**`HUD` `client` [`0xC8E1071177A23BE5`](https://docs.fivem.net/natives/?_0xC8E1071177A23BE5)**
---
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`HUD` `client` [`0xCA6B2F7CE32AB653`](https://docs.fivem.net/natives/?_0xCA6B2F7CE32AB653)**
---
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`HUD` `client` [`0xCD74233600C4EA6B`](https://docs.fivem.net/natives/?_0xCD74233600C4EA6B)**
---
---```
...
---**`HUD` `client` [`0xD1942374085C8469`](https://docs.fivem.net/natives/?_0xD1942374085C8469)**
---
---@param p0 any
function N_0xd1942374085c8469(p0) end

---**`HUD` `client` [`0xD2049635DEB9C375`](https://docs.fivem.net/natives/?_0xD2049635DEB9C375)**
---
---**This native does absolutely nothing, just a nullsub**
---
function N_0xd2049635deb9c375() end

---**`HUD` `client` [`0xDAF87174BE7454FF`](https://docs.fivem.net/natives/?_0xDAF87174BE7454FF)**
---
---@param p0 any
---@return boolean
function N_0xdaf87174be7454ff(p0) end

---**`HUD` `client` [`0xDE03620F8703A9DF`](https://docs.fivem.net/natives/?_0xDE03620F8703A9DF)**
---
---@return any
function N_0xde03620f8703a9df() end

---**`HUD` `client` [`0xE4C3B169876D33D7`](https://docs.fivem.net/natives/?_0xE4C3B169876D33D7)**
---
---```
---NativeDB Introduced: v1290
---```
...
---**`HUD` `client` [`0xE67C6DFD386EA5E7`](https://docs.fivem.net/natives/?_0xE67C6DFD386EA5E7)**
---
---@param p0 boolean
function N_0xe67c6dfd386ea5e7(p0) end

---**`HUD` `client` [`0xEB81A3DADD503187`](https://docs.fivem.net/natives/?_0xEB81A3DADD503187)**
---
---```
---NativeDB Introduced: v1290
---```
...
---**`HUD` `client` [`0xF13FE2A80C05C561`](https://docs.fivem.net/natives/?_0xF13FE2A80C05C561)**
---
---@return boolean
function N_0xf13fe2a80c05c561() end

---**`HUD` `client` [`0xF284AC67940C6812`](https://docs.fivem.net/natives/?_0xF284AC67940C6812)**
---
---@return any
function N_0xf284ac67940c6812() end

---**`HUD` `client` [`0xF83D0FEBE75E62C9`](https://docs.fivem.net/natives/?_0xF83D0FEBE75E62C9)**
---
---```
...
---**`HUD` `client` [`0xEF01D36B9C9D0C7B`](https://docs.fivem.net/natives/?_0xEF01D36B9C9D0C7B)**
---
...
---**`HUD` `client` [`0x5A039BB0BCA604B6`](https://docs.fivem.net/natives/?_0x5A039BB0BCA604B6)**
---
...
---**`HUD` `client` [`0x5CDE92C702A8FCE7`](https://docs.fivem.net/natives/?_0x5CDE92C702A8FCE7)**
---
...
---**`HUD` `client` [`0xBE339365C863BD36`](https://docs.fivem.net/natives/?_0xBE339365C863BD36)**
---
---@param pickup Pickup
---@return Blip
function AddBlipForPickup(pickup) end

---**`HUD` `client` [`0x46818D79B1F7499A`](https://docs.fivem.net/natives/?_0x46818D79B1F7499A)**
---
...
---**`HUD` `client` [`0x60296AF4BA14ABC5`](https://docs.fivem.net/natives/?_0x60296AF4BA14ABC5)**
---
---@param p0 boolean
function AddNextMessageToPreviousBriefs(p0) end

---**`HUD` `client` [`0x311438A071DD9B1A`](https://docs.fivem.net/natives/?_0x311438A071DD9B1A)**
---
---@param x number
---@param y number
---@param z number
...
---**`HUD` `client` [`0xA905192A6781C41B`](https://docs.fivem.net/natives/?_0xA905192A6781C41B)**
---
---@param x number
---@param y number
---@param z number
...
---**`HUD` `client` [`0xE7DCB5B874BCD96E`](https://docs.fivem.net/natives/?_0xE7DCB5B874BCD96E)**
---
...
---**`HUD` `client` [`0x0E4C749FF9DE9CC4`](https://docs.fivem.net/natives/?_0x0E4C749FF9DE9CC4)**
---
---Example code:
---```lua
----- on initialization
...
---**`HUD` `client` [`0x03B504CF259931BC`](https://docs.fivem.net/natives/?_0x03B504CF259931BC)**
---
---@param value number
function AddTextComponentInteger(value) end

---**`HUD` `client` [`0x80EAD8E2E1D5D52E`](https://docs.fivem.net/natives/?_0x80EAD8E2E1D5D52E)**
---
---@param blip Blip
function AddTextComponentSubstringBlipName(blip) end

---**`HUD` `client` [`0x5F68520888E69014`](https://docs.fivem.net/natives/?_0x5F68520888E69014)**
---
---@param string string
function AddTextComponentSubstringKeyboardDisplay(string) end

---**`HUD` `client` [`0x761B77454205A61D`](https://docs.fivem.net/natives/?_0x761B77454205A61D)**
---
---```
---p1 was always -1
---```
...
---**`HUD` `client` [`0x6C188BE134E074AA`](https://docs.fivem.net/natives/?_0x6C188BE134E074AA)**
---
...
---**`HUD` `client` [`0xC63CD5D2920ACBE7`](https://docs.fivem.net/natives/?_0xC63CD5D2920ACBE7)**
---
...
---**`HUD` `client` [`0x60734CC207C9833C`](https://docs.fivem.net/natives/?_0x60734CC207C9833C)**
---
---@param toggle boolean
...
---**`HUD` `client` [`0x0A24DA3A41B718F5`](https://docs.fivem.net/natives/?_0x0A24DA3A41B718F5)**
---
---Example code:
---```lua
...
---**`HUD` `client` [`0x8F9EE5687F8EECCD`](https://docs.fivem.net/natives/?_0x8F9EE5687F8EECCD)**
---
...
---**`HUD` `client` [`0xF9113A30DE5C6670`](https://docs.fivem.net/natives/?_0xF9113A30DE5C6670)**
---
...
---**`HUD` `client` [`0x202709F4C58A0424`](https://docs.fivem.net/natives/?_0x202709F4C58A0424)**
---
...
---**`HUD` `client` [`0xB2A592B04648A9CB`](https://docs.fivem.net/natives/?_0xB2A592B04648A9CB)**
---
---@return boolean
function BusyspinnerIsDisplaying() end

---**`HUD` `client` [`0xD422FCC5F239A915`](https://docs.fivem.net/natives/?_0xD422FCC5F239A915)**
---
---@return boolean
function BusyspinnerIsOn() end

---**`HUD` `client` [`0x10D373323E5B9C0D`](https://docs.fivem.net/natives/?_0x10D373323E5B9C0D)**
---
---```
...
---**`HUD` `client` [`0x2A179DF17CCF04CD`](https://docs.fivem.net/natives/?_0x2A179DF17CCF04CD)**
---
---@param p0 number
---@param p1 boolean
function ClearAdditionalText(p0, p1) end

---**`HUD` `client` [`0x6178F68A87A4D3A0`](https://docs.fivem.net/natives/?_0x6178F68A87A4D3A0)**
---
function ClearAllHelpMessages() end

---**`HUD` `client` [`0x9D292F73ADBD9313`](https://docs.fivem.net/natives/?_0x9D292F73ADBD9313)**
---
function ClearBrief() end

---**`HUD` `client` [`0x7792424AA0EAC32E`](https://docs.fivem.net/natives/?_0x7792424AA0EAC32E)**
---
function ClearDynamicPauseMenuErrorMessage() end

---**`HUD` `client` [`0x50085246ABD3FEFA`](https://docs.fivem.net/natives/?_0x50085246ABD3FEFA)**
---
---@param hudIndex number
---@param p1 boolean
function ClearFloatingHelp(hudIndex, p1) end

---**`HUD` `client` [`0xE6DE0561D9232A64`](https://docs.fivem.net/natives/?_0xE6DE0561D9232A64)**
---
...
---**`HUD` `client` [`0xFF4FB7C8CDFA3DA7`](https://docs.fivem.net/natives/?_0xFF4FB7C8CDFA3DA7)**
---
function ClearGpsPlayerWaypoint() end

---**`HUD` `client` [`0x7AA5B4CE533C858B`](https://docs.fivem.net/natives/?_0x7AA5B4CE533C858B)**
---
---```
...
---**`HUD` `client` [`0x8DFCED7A656F8802`](https://docs.fivem.net/natives/?_0x8DFCED7A656F8802)**
---
---@param toggle boolean
function ClearHelp(toggle) end

---**`HUD` `client` [`0x5E62BE5DC58E9E06`](https://docs.fivem.net/natives/?_0x5E62BE5DC58E9E06)**
---
function ClearPedInPauseMenu() end

---**`HUD` `client` [`0xCC33FA791322B9D9`](https://docs.fivem.net/natives/?_0xCC33FA791322B9D9)**
---
function ClearPrints() end

---**`HUD` `client` [`0xB57D8DD645CFA2CF`](https://docs.fivem.net/natives/?_0xB57D8DD645CFA2CF)**
---
---**This native does absolutely nothing, just a nullsub**
---
function ClearReminderMessage() end

---**`HUD` `client` [`0x2CEA2839313C09AC`](https://docs.fivem.net/natives/?_0x2CEA2839313C09AC)**
---
...
---**`HUD` `client` [`0xD2B32BE3FC1626C6`](https://docs.fivem.net/natives/?_0xD2B32BE3FC1626C6)**
---
function CloseSocialClubMenu() end

---**`HUD` `client` [`0xBFEFE3321A3F5015`](https://docs.fivem.net/natives/?_0xBFEFE3321A3F5015)**
---
...
---@return number # The ID of the new gamer tag.
function CreateFakeMpGamerTag(ped, username, crewIsPrivate, crewIsRockstar, crewName, crewRank) end

---**`HUD` `client` [`0x6DD05E9D83EFA4C9`](https://docs.fivem.net/natives/?_0x6DD05E9D83EFA4C9)**
---
...
---**`HUD` `client` [`0xA5E78BA2B1331C55`](https://docs.fivem.net/natives/?_0xA5E78BA2B1331C55)**
---
---@param display boolean
function DisplayAmmoThisFrame(display) end

---**`HUD` `client` [`0x276B6CE369C33678`](https://docs.fivem.net/natives/?_0x276B6CE369C33678)**
---
---@param toggle boolean
...
---**`HUD` `client` [`0x402F9ED62087E898`](https://docs.fivem.net/natives/?_0x402F9ED62087E898)**
---
function DisplayHudWhenPausedThisFrame() end

---**`HUD` `client` [`0x82CEDC33687E1F50`](https://docs.fivem.net/natives/?_0x82CEDC33687E1F50)**
---
...
---**`HUD` `client` [`0xA0EBB943C300E693`](https://docs.fivem.net/natives/?_0xA0EBB943C300E693)**
---
---```
...
---**`HUD` `client` [`0xA6DB27D19ECBB7DA`](https://docs.fivem.net/natives/?_0xA6DB27D19ECBB7DA)**
---
---@param blip Blip
---@return boolean
function DoesBlipExist(blip) end

---**`HUD` `client` [`0xDD2238F57B977751`](https://docs.fivem.net/natives/?_0xDD2238F57B977751)**
---
---@param blip Blip
---@return boolean
...
---**`HUD` `client` [`0x1C7302E725259789`](https://docs.fivem.net/natives/?_0x1C7302E725259789)**
---
---@param gxt string
---@return boolean
...
---**`HUD` `client` [`0x6D14BFDC33B34F55`](https://docs.fivem.net/natives/?_0x6D14BFDC33B34F55)**
---
---```
...
---**`HUD` `client` [`0xBD12F8228410D9B4`](https://docs.fivem.net/natives/?_0xBD12F8228410D9B4)**
---
---```
...
---**`HUD` `client` [`0xFCC75460ABA29378`](https://docs.fivem.net/natives/?_0xFCC75460ABA29378)**
---
function EndTextCommandClearPrint() end

---**`HUD` `client` [`0x238FFE5C7B0498A6`](https://docs.fivem.net/natives/?_0x238FFE5C7B0498A6)**
---
---Example code:
---```lua
...
---**`HUD` `client` [`0x8A9BA1AB3E237613`](https://docs.fivem.net/natives/?_0x8A9BA1AB3E237613)**
---
---@return boolean
function EndTextCommandIsMessageDisplayed() end

---**`HUD` `client` [`0x10BDDBFC529428DD`](https://docs.fivem.net/natives/?_0x10BDDBFC529428DD)**
---
...
---@return boolean # `true`: Indicates if the specific help message has been displayed.\<br>`false`: Indicates that the specific help message is still being displayed.
function EndTextCommandIsThisHelpMessageBeingDisplayed(hudIndex) end

---**`HUD` `client` [`0xA86911979638106F`](https://docs.fivem.net/natives/?_0xA86911979638106F)**
---
...
---**`HUD` `client` [`0xBC38B49BCB83BC9B`](https://docs.fivem.net/natives/?_0xBC38B49BCB83BC9B)**
---
...
---**`HUD` `client` [`0xAA295B6F28BD587D`](https://docs.fivem.net/natives/?_0xAA295B6F28BD587D)**
---
...
---**`HUD` `client` [`0x1CCD9A37359072CF`](https://docs.fivem.net/natives/?_0x1CCD9A37359072CF)**
---
...
---**`HUD` `client` [`0x2B7E9A4EAAA93C89`](https://docs.fivem.net/natives/?_0x2B7E9A4EAAA93C89)**
---
...
---**`HUD` `client` [`0x2ED7843F8F801023`](https://docs.fivem.net/natives/?_0x2ED7843F8F801023)**
---
...
---**`HUD` `client` [`0x44FA03975424A0EE`](https://docs.fivem.net/natives/?_0x44FA03975424A0EE)**
---
---@param blink boolean
---@param bHasTokens boolean
---@return number
...
---**`HUD` `client` [`0x378E809BF61EC840`](https://docs.fivem.net/natives/?_0x378E809BF61EC840)**
---
---@param isImportant boolean
---@param bHasTokens boolean
---@return number
...
---**`HUD` `client` [`0x33EE12743CCD6343`](https://docs.fivem.net/natives/?_0x33EE12743CCD6343)**
---
---@param chTitle string
---@param iconType number
...
---**`HUD` `client` [`0xC8F3AAF93D0600BF`](https://docs.fivem.net/natives/?_0xC8F3AAF93D0600BF)**
---
---@param chTitle string
---@param iconType number
---@param chSubtitle string
...
---**`HUD` `client` [`0x7AE0589093A2E088`](https://docs.fivem.net/natives/?_0x7AE0589093A2E088)**
---
---@param chTitle string
---@param iconType number
---@param chSubtitle string
...
---**`HUD` `client` [`0xB6871B0555B02996`](https://docs.fivem.net/natives/?_0xB6871B0555B02996)**
---
---```
...
---**`HUD` `client` [`0xCEF214315D276FD1`](https://docs.fivem.net/natives/?_0xCEF214315D276FD1)**
---
---@param toggle boolean
function FlagPlayerContextInTournament(toggle) end

---**`HUD` `client` [`0x02CFBA0C9E9275CE`](https://docs.fivem.net/natives/?_0x02CFBA0C9E9275CE)**
---
...
---**`HUD` `client` [`0x6B1DE27EE78E6A19`](https://docs.fivem.net/natives/?_0x6B1DE27EE78E6A19)**
---
---@param hudColorIndex number
function FlashMinimapDisplayWithColor(hudColorIndex) end

---**`HUD` `client` [`0xA18AFB39081B6A1F`](https://docs.fivem.net/natives/?_0xA18AFB39081B6A1F)**
---
---@param p0 boolean
function FlashWantedDisplay(p0) end

---**`HUD` `client` [`0xEE4C0E6DBC6F2C6F`](https://docs.fivem.net/natives/?_0xEE4C0E6DBC6F2C6F)**
---
function ForceCloseReportugcMenu() end

---**`HUD` `client` [`0x1121BFA1A1A522A8`](https://docs.fivem.net/natives/?_0x1121BFA1A1A522A8)**
---
---```
...
---**`HUD` `client` [`0x970F608F0EE6C885`](https://docs.fivem.net/natives/?_0x970F608F0EE6C885)**
---
---@param blip Blip
---@return number
function GetBlipAlpha(blip) end

---**`HUD` `client` [`0xDF729E8D20CF7327`](https://docs.fivem.net/natives/?_0xDF729E8D20CF7327)**
---
---@param blip Blip
---@return number
function GetBlipColour(blip) end

---**`HUD` `client` [`0x586AFE3FF72D996E`](https://docs.fivem.net/natives/?_0x586AFE3FF72D996E)**
---
---@param blip Blip
---@return vector3
...
---**`HUD` `client` [`0x729B5F1EFBC0AAEE`](https://docs.fivem.net/natives/?_0x729B5F1EFBC0AAEE)**
---
---@param blip Blip
---@return number
function GetBlipHudColour(blip) end

---**`HUD` `client` [`0xFA7C7F0AADF25D09`](https://docs.fivem.net/natives/?_0xFA7C7F0AADF25D09)**
---
---@param blip Blip
---@return vector3
function GetBlipInfoIdCoord(blip) end

---**`HUD` `client` [`0x1E314167F701DC3B`](https://docs.fivem.net/natives/?_0x1E314167F701DC3B)**
---
---@param blip Blip
---@return number
function GetBlipInfoIdDisplay(blip) end

---**`HUD` `client` [`0x4BA4E2553AFEDC2C`](https://docs.fivem.net/natives/?_0x4BA4E2553AFEDC2C)**
---
---@param blip Blip
---@return Entity
...
---**`HUD` `client` [`0xBE9B0959FFD0779B`](https://docs.fivem.net/natives/?_0xBE9B0959FFD0779B)**
---
---```
...
---**`HUD` `client` [`0x1FC877464A04FC4F`](https://docs.fivem.net/natives/?_0x1FC877464A04FC4F)**
---
...
---**`HUD` `client` [`0x2309595AD6145265`](https://docs.fivem.net/natives/?_0x2309595AD6145265)**
---
---```
...
---**`HUD` `client` [`0x01A358D9128B7A86`](https://docs.fivem.net/natives/?_0x01A358D9128B7A86)**
---
---@return number
function GetCurrentWebpageId() end

---**`HUD` `client` [`0x97D47996FC48CBAD`](https://docs.fivem.net/natives/?_0x97D47996FC48CBAD)**
---
---@return number
...
---**`HUD` `client` [`0x7C9C91AB74A0360F`](https://docs.fivem.net/natives/?_0x7C9C91AB74A0360F)**
---
...
---**`HUD` `client` [`0x223CA69A8C4417FD`](https://docs.fivem.net/natives/?_0x223CA69A8C4417FD)**
---
---@param id number
---@return vector3
function GetHudComponentPosition(id) end

---**`HUD` `client` [`0xF9904D11F1ACBEC3`](https://docs.fivem.net/natives/?_0xF9904D11F1ACBEC3)**
---
---```
...
---**`HUD` `client` [`0x43E4111189E54F0E`](https://docs.fivem.net/natives/?_0x43E4111189E54F0E)**
---
---@param string string
---@return number
...
---**`HUD` `client` [`0xDCD4EC3F419D02FA`](https://docs.fivem.net/natives/?_0xDCD4EC3F419D02FA)**
---
---@return Blip
function GetMainPlayerBlipId() end

---**`HUD` `client` [`0x052991E59076E4E4`](https://docs.fivem.net/natives/?_0x052991E59076E4E4)**
---
---```
...
---**`HUD` `client` [`0x5FBD7095FE7AE57F`](https://docs.fivem.net/natives/?_0x5FBD7095FE7AE57F)**
---
---@param p0 any
---@param p1 number
...
---**`HUD` `client` [`0xEF4CED81CEBEDC6D`](https://docs.fivem.net/natives/?_0xEF4CED81CEBEDC6D)**
---
---@param p0 any
---@param p1 any
---@return boolean, any
...
---**`HUD` `client` [`0x90A6526CF0381030`](https://docs.fivem.net/natives/?_0x90A6526CF0381030)**
---
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`HUD` `client` [`0x6E31B91145873922`](https://docs.fivem.net/natives/?_0x6E31B91145873922)**
---
---@param x number
---@param y number
---@param z number
...
---**`HUD` `client` [`0xE0130B41D3CF4574`](https://docs.fivem.net/natives/?_0xE0130B41D3CF4574)**
---
---@return number
function GetMinimapFowDiscoveryRatio() end

---**`HUD` `client` [`0x1A6478B61C6BDC3B`](https://docs.fivem.net/natives/?_0x1A6478B61C6BDC3B)**
---
---@param name string
---@return number
function GetNamedRendertargetRenderId(name) end

---**`HUD` `client` [`0x5C90988E7C8E1AF4`](https://docs.fivem.net/natives/?_0x5C90988E7C8E1AF4)**
---
---@return Blip
...
---**`HUD` `client` [`0x272ACD84970869C5`](https://docs.fivem.net/natives/?_0x272ACD84970869C5)**
---
---```
---Returns:
---0
...
---**`HUD` `client` [`0xDB88A37483346780`](https://docs.fivem.net/natives/?_0xDB88A37483346780)**
---
---```
...
---**`HUD` `client` [`0x4A9923385BDB9DAD`](https://docs.fivem.net/natives/?_0x4A9923385BDB9DAD)**
---
---@return number
function GetStandardBlipEnumId() end

---**`HUD` `client` [`0xD0EF8A959B8A4CB9`](https://docs.fivem.net/natives/?_0xD0EF8A959B8A4CB9)**
---
...
---**`HUD` `client` [`0x186E5D252FA50E7D`](https://docs.fivem.net/natives/?_0x186E5D252FA50E7D)**
---
---@return number
...
---**`HUD` `client` [`0x02245FE4BED318B8`](https://docs.fivem.net/natives/?_0x02245FE4BED318B8)**
---
---@param slot number
---@return boolean
...
---**`HUD` `client` [`0xD46923FC481CA285`](https://docs.fivem.net/natives/?_0xD46923FC481CA285)**
---
...
---**`HUD` `client` [`0x6806C51AD12B83B8`](https://docs.fivem.net/natives/?_0x6806C51AD12B83B8)**
---
...
---**`HUD` `client` [`0x4B0311D3CDC4648F`](https://docs.fivem.net/natives/?_0x4B0311D3CDC4648F)**
---
function HideLoadingOnFadeThisFrame() end

---**`HUD` `client` [`0x5FBAE526203990C9`](https://docs.fivem.net/natives/?_0x5FBAE526203990C9)**
---
function HideMinimapExteriorMapThisFrame() end

---**`HUD` `client` [`0x20FE7FDFEEAD38C0`](https://docs.fivem.net/natives/?_0x20FE7FDFEEAD38C0)**
---
function HideMinimapInteriorMapThisFrame() end

---**`HUD` `client` [`0x532CFF637EF80148`](https://docs.fivem.net/natives/?_0x532CFF637EF80148)**
---
---@param blip Blip
function HideNumberOnBlip(blip) end

---**`HUD` `client` [`0xE374C498D8BADC14`](https://docs.fivem.net/natives/?_0xE374C498D8BADC14)**
---
---@param id number
function HideScriptedHudComponentThisFrame(id) end

---**`HUD` `client` [`0xEB354E5376BC81A7`](https://docs.fivem.net/natives/?_0xEB354E5376BC81A7)**
---
---```
...
---**`HUD` `client` [`0x72C1056D678BB7D8`](https://docs.fivem.net/natives/?_0x72C1056D678BB7D8)**
---
---```
...
---**`HUD` `client` [`0xA5E41FD83AD6CEF0`](https://docs.fivem.net/natives/?_0xA5E41FD83AD6CEF0)**
---
---@param blip Blip
---@return boolean
function IsBlipFlashing(blip) end

---**`HUD` `client` [`0xE41CA53051197A27`](https://docs.fivem.net/natives/?_0xE41CA53051197A27)**
---
---@param blip Blip
---@return boolean
function IsBlipOnMinimap(blip) end

---**`HUD` `client` [`0xDA5F8727EB75B926`](https://docs.fivem.net/natives/?_0xDA5F8727EB75B926)**
---
---@param blip Blip
---@return boolean
function IsBlipShortRange(blip) end

---**`HUD` `client` [`0x2432784ACA090DA4`](https://docs.fivem.net/natives/?_0x2432784ACA090DA4)**
---
---@param hudIndex number
---@return boolean
function IsFloatingHelpTextOnScreen(hudIndex) end

---**`HUD` `client` [`0x3BAB9A4E4F2FF5C7`](https://docs.fivem.net/natives/?_0x3BAB9A4E4F2FF5C7)**
---
---@return boolean
function IsFrontendReadyForControl() end

---**`HUD` `client` [`0x4D79439A6B55AC67`](https://docs.fivem.net/natives/?_0x4D79439A6B55AC67)**
---
---@return boolean
function IsHelpMessageBeingDisplayed() end

---**`HUD` `client` [`0x327EDEEEAC55C369`](https://docs.fivem.net/natives/?_0x327EDEEEAC55C369)**
---
---@return boolean
function IsHelpMessageFadingOut() end

---**`HUD` `client` [`0xDAD37F45428801AE`](https://docs.fivem.net/natives/?_0xDAD37F45428801AE)**
---
---@return boolean
function IsHelpMessageOnScreen() end

---**`HUD` `client` [`0x4167EFE0527D706E`](https://docs.fivem.net/natives/?_0x4167EFE0527D706E)**
---
---@return boolean
...
---**`HUD` `client` [`0xA86478C6958735C5`](https://docs.fivem.net/natives/?_0xA86478C6958735C5)**
---
---@return boolean
function IsHudHidden() end

---**`HUD` `client` [`0x1930DFA731813EC4`](https://docs.fivem.net/natives/?_0x1930DFA731813EC4)**
---
---@return boolean
function IsHudPreferenceSwitchedOn() end

---**`HUD` `client` [`0x7984C03AA5CC2F41`](https://docs.fivem.net/natives/?_0x7984C03AA5CC2F41)**
---
---@return boolean
function IsMessageBeingDisplayed() end

---**`HUD` `client` [`0xAF754F20EB5CD51A`](https://docs.fivem.net/natives/?_0xAF754F20EB5CD51A)**
---
---@return boolean
function IsMinimapRendering() end

---**`HUD` `client` [`0x26F49BF3381D933D`](https://docs.fivem.net/natives/?_0x26F49BF3381D933D)**
---
---@param blip Blip
---@return boolean
function IsMissionCreatorBlip(blip) end

---**`HUD` `client` [`0x4E929E7A5796FD26`](https://docs.fivem.net/natives/?_0x4E929E7A5796FD26)**
---
---@param gamerTagId number
---@return boolean
function IsMpGamerTagActive(gamerTagId) end

---**`HUD` `client` [`0x595B5178E412E199`](https://docs.fivem.net/natives/?_0x595B5178E412E199)**
---
---@param gamerTagId number
---@return boolean
function IsMpGamerTagFree(gamerTagId) end

---**`HUD` `client` [`0x6E0EB3EB47C8D7AA`](https://docs.fivem.net/natives/?_0x6E0EB3EB47C8D7AA)**
---
---@return boolean
function IsMpGamerTagMovieActive() end

---**`HUD` `client` [`0x113750538FA31298`](https://docs.fivem.net/natives/?_0x113750538FA31298)**
---
---@param modelHash Hash
---@return boolean
function IsNamedRendertargetLinked(modelHash) end

---**`HUD` `client` [`0x78DCDC15C9F116B4`](https://docs.fivem.net/natives/?_0x78DCDC15C9F116B4)**
---
---@param name string
---@return boolean
function IsNamedRendertargetRegistered(name) end

---**`HUD` `client` [`0x4E3CD0EF8A489541`](https://docs.fivem.net/natives/?_0x4E3CD0EF8A489541)**
---
---@return any
function IsNavigatingMenuContent() end

---**`HUD` `client` [`0x6F72CD94F7B5B68C`](https://docs.fivem.net/natives/?_0x6F72CD94F7B5B68C)**
---
...
---**`HUD` `client` [`0x1C491717107431C7`](https://docs.fivem.net/natives/?_0x1C491717107431C7)**
---
---@return boolean
function IsPauseMenuRestarting() end

---**`HUD` `client` [`0x157F93B036700462`](https://docs.fivem.net/natives/?_0x157F93B036700462)**
---
---@return boolean
function IsRadarHidden() end

---**`HUD` `client` [`0x9EB6522EA68F22FE`](https://docs.fivem.net/natives/?_0x9EB6522EA68F22FE)**
---
---@return boolean
function IsRadarPreferenceSwitchedOn() end

---**`HUD` `client` [`0x9135584D09A3437E`](https://docs.fivem.net/natives/?_0x9135584D09A3437E)**
---
---@return boolean
function IsReportugcMenuOpen() end

---**`HUD` `client` [`0xDD100EB17A94FF65`](https://docs.fivem.net/natives/?_0xDD100EB17A94FF65)**
---
---@param id number
---@return boolean
function IsScriptedHudComponentActive(id) end

---**`HUD` `client` [`0x09C0403ED9A751C2`](https://docs.fivem.net/natives/?_0x09C0403ED9A751C2)**
---
---@param id number
---@return boolean
function IsScriptedHudComponentHiddenThisFrame(id) end

---**`HUD` `client` [`0xC406BE343FC4B9AF`](https://docs.fivem.net/natives/?_0xC406BE343FC4B9AF)**
---
---@return boolean
function IsSocialClubActive() end

---**`HUD` `client` [`0x8B6817B71B85EBF0`](https://docs.fivem.net/natives/?_0x8B6817B71B85EBF0)**
---
---@param p0 number
---@return boolean
function IsStreamingAdditionalText(p0) end

---**`HUD` `client` [`0xAD6DACA4BA53E0A4`](https://docs.fivem.net/natives/?_0xAD6DACA4BA53E0A4)**
---
---@return boolean
function IsSubtitlePreferenceSwitchedOn() end

---**`HUD` `client` [`0xE18B138FABC53103`](https://docs.fivem.net/natives/?_0xE18B138FABC53103)**
---
...
---**`HUD` `client` [`0x1DD1F58F493F1DA5`](https://docs.fivem.net/natives/?_0x1DD1F58F493F1DA5)**
---
---@return boolean
function IsWaypointActive() end

---**`HUD` `client` [`0xF6C09E276AEB3F2D`](https://docs.fivem.net/natives/?_0xF6C09E276AEB3F2D)**
---
---@param modelHash Hash
...
---**`HUD` `client` [`0x805D7CBB36FD6C4C`](https://docs.fivem.net/natives/?_0x805D7CBB36FD6C4C)**
---
function OpenOnlinePoliciesMenu() end

---**`HUD` `client` [`0x523A590C1A3CC0D3`](https://docs.fivem.net/natives/?_0x523A590C1A3CC0D3)**
---
---```
...
---**`HUD` `client` [`0x75D3691713C3B05A`](https://docs.fivem.net/natives/?_0x75D3691713C3B05A)**
---
---Uses the `SOCIAL_CLUB2` scaleform.
---
function OpenSocialClubMenu() end

---**`HUD` `client` [`0x77F16B447824DA6C`](https://docs.fivem.net/natives/?_0x77F16B447824DA6C)**
---
...
---**`HUD` `client` [`0xCDCA26E80FAECB8F`](https://docs.fivem.net/natives/?_0xCDCA26E80FAECB8F)**
---
...
---**`HUD` `client` [`0xDD564BDD0472C936`](https://docs.fivem.net/natives/?_0xDD564BDD0472C936)**
---
...
---**`HUD` `client` [`0x444D8CF241EC25C5`](https://docs.fivem.net/natives/?_0x444D8CF241EC25C5)**
---
---@param contextHash Hash
function PauseMenuDeactivateContext(contextHash) end

---**`HUD` `client` [`0x84698AB38D0C6636`](https://docs.fivem.net/natives/?_0x84698AB38D0C6636)**
---
---@param contextHash Hash
---@return boolean
function PauseMenuIsContextActive(contextHash) end

---**`HUD` `client` [`0x2A25ADC48F87841F`](https://docs.fivem.net/natives/?_0x2A25ADC48F87841F)**
---
---@return any
function PauseMenuIsContextMenuActive() end

---**`HUD` `client` [`0x4895BDEA16E7C080`](https://docs.fivem.net/natives/?_0x4895BDEA16E7C080)**
---
...
---**`HUD` `client` [`0xC78E239AC5B2DDB9`](https://docs.fivem.net/natives/?_0xC78E239AC5B2DDB9)**
---
---@param p0 boolean
---@param p1 any
---@param p2 any
...
---**`HUD` `client` [`0xF06EBB91A81E09E3`](https://docs.fivem.net/natives/?_0xF06EBB91A81E09E3)**
---
...
---**`HUD` `client` [`0x742D6FD43115AF73`](https://docs.fivem.net/natives/?_0x742D6FD43115AF73)**
---
---@param blip Blip
function PulseBlip(blip) end

---**`HUD` `client` [`0x81FA173F170560D1`](https://docs.fivem.net/natives/?_0x81FA173F170560D1)**
---
function RefreshWaypoint() end

---**`HUD` `client` [`0x57D9C12635E25CE3`](https://docs.fivem.net/natives/?_0x57D9C12635E25CE3)**
---
---@param name string
---@param p1 boolean
---@return boolean
...
---**`HUD` `client` [`0x14621BB1DF14E2B2`](https://docs.fivem.net/natives/?_0x14621BB1DF14E2B2)**
---
...
---**`HUD` `client` [`0xE9F6FFE837354DD4`](https://docs.fivem.net/natives/?_0xE9F6FFE837354DD4)**
---
---@param name string
---@return boolean
...
---**`HUD` `client` [`0x31698AA80E0223F8`](https://docs.fivem.net/natives/?_0x31698AA80E0223F8)**
---
...
---**`HUD` `client` [`0xC7C6789AA1CFEDD0`](https://docs.fivem.net/natives/?_0xC7C6789AA1CFEDD0)**
---
...
---**`HUD` `client` [`0x95CF81BD06EE1887`](https://docs.fivem.net/natives/?_0x95CF81BD06EE1887)**
---
function RemoveMultiplayerWalletCash() end

---**`HUD` `client` [`0x1CCC708F0F850613`](https://docs.fivem.net/natives/?_0x1CCC708F0F850613)**
---
...
---**`HUD` `client` [`0xF314CF4F0211894E`](https://docs.fivem.net/natives/?_0xF314CF4F0211894E)**
---
---Hud colors can be found [here](https://docs.fivem.net/docs/game-references/hud-colors/)
---
---@param hudColorIndex number
...
---**`HUD` `client` [`0x6009F9F1AE90D8A6`](https://docs.fivem.net/natives/?_0x6009F9F1AE90D8A6)**
---
---@param gxt string
---@param slot number
function RequestAdditionalTextForDlc(gxt, slot) end

---**`HUD` `client` [`0xB99C4E4D9499DF29`](https://docs.fivem.net/natives/?_0xB99C4E4D9499DF29)**
---
---@param flagIndex number
function ResetGlobalActionscriptFlag(flagIndex) end

---**`HUD` `client` [`0x450930E616475D0D`](https://docs.fivem.net/natives/?_0x450930E616475D0D)**
---
---@param id number
function ResetHudComponentValues(id) end

---**`HUD` `client` [`0x12782CE0A636E9F0`](https://docs.fivem.net/natives/?_0x12782CE0A636E9F0)**
---
...
---**`HUD` `client` [`0x231C8F89D0539D8F`](https://docs.fivem.net/natives/?_0x231C8F89D0539D8F)**
---
...
---**`HUD` `client` [`0x45FF974EEE1C8734`](https://docs.fivem.net/natives/?_0x45FF974EEE1C8734)**
---
---```
...
---**`HUD` `client` [`0x6F6F290102C02AB4`](https://docs.fivem.net/natives/?_0x6F6F290102C02AB4)**
---
...
---**`HUD` `client` [`0x24AC0137444F9FD5`](https://docs.fivem.net/natives/?_0x24AC0137444F9FD5)**
---
---@param blip Blip
---@param toggle boolean
function SetBlipAsMissionCreatorBlip(blip, toggle) end

---**`HUD` `client` [`0xBE8BE4FE60E27B72`](https://docs.fivem.net/natives/?_0xBE8BE4FE60E27B72)**
---
...
---**`HUD` `client` [`0xB203913733F27884`](https://docs.fivem.net/natives/?_0xB203913733F27884)**
---
---@param blip Blip
---@param toggle boolean
function SetBlipBright(blip, toggle) end

---**`HUD` `client` [`0x234CDD44D996FD9A`](https://docs.fivem.net/natives/?_0x234CDD44D996FD9A)**
---
---Examples result:
---
...
---**`HUD` `client` [`0x03D7FB09E75D6B7E`](https://docs.fivem.net/natives/?_0x03D7FB09E75D6B7E)**
---
---@param blip Blip
...
---**`HUD` `client` [`0xAE2AF67E9D9AF65D`](https://docs.fivem.net/natives/?_0xAE2AF67E9D9AF65D)**
---
---@param blip Blip
---@param posX number
---@param posY number
...
---**`HUD` `client` [`0x2AEE8F8390D2298C`](https://docs.fivem.net/natives/?_0x2AEE8F8390D2298C)**
---
---@param blip Blip
...
---**`HUD` `client` [`0xB14552383D39CE3E`](https://docs.fivem.net/natives/?_0xB14552383D39CE3E)**
---
---@param blip Blip
---@param toggle boolean
function SetBlipFlashes(blip, toggle) end

---**`HUD` `client` [`0x2E8D9498C56DD0D1`](https://docs.fivem.net/natives/?_0x2E8D9498C56DD0D1)**
---
---@param blip Blip
---@param toggle boolean
function SetBlipFlashesAlternate(blip, toggle) end

---**`HUD` `client` [`0xAA51DB313C010A7E`](https://docs.fivem.net/natives/?_0xAA51DB313C010A7E)**
---
...
---**`HUD` `client` [`0xD3CD6FD297AE87CC`](https://docs.fivem.net/natives/?_0xD3CD6FD297AE87CC)**
---
...
---**`HUD` `client` [`0x54318C915D27E4CE`](https://docs.fivem.net/natives/?_0x54318C915D27E4CE)**
---
---@param blip Blip
---@param toggle boolean
function SetBlipHiddenOnLegend(blip, toggle) end

---**`HUD` `client` [`0xE2590BC29220CEBB`](https://docs.fivem.net/natives/?_0xE2590BC29220CEBB)**
---
---@param blip Blip
---@param toggle boolean
...
---**`HUD` `client` [`0x127DE7B20C60A6A3`](https://docs.fivem.net/natives/?_0x127DE7B20C60A6A3)**
---
---@param blip Blip
---@param player Player
...
---**`HUD` `client` [`0xF87683CDF73C3F6E`](https://docs.fivem.net/natives/?_0xF87683CDF73C3F6E)**
---
---```
...
---**`HUD` `client` [`0x837155CD2F63DA09`](https://docs.fivem.net/natives/?_0x837155CD2F63DA09)**
---
---@param blip Blip
---@param colour number
function SetBlipRouteColour(blip, colour) end

---**`HUD` `client` [`0xD38744167B2FA257`](https://docs.fivem.net/natives/?_0xD38744167B2FA257)**
---
---@param blip Blip
---@param scale number
function SetBlipScale(blip, scale) end

---**`HUD` `client` [`0x14892474891E09EB`](https://docs.fivem.net/natives/?_0x14892474891E09EB)**
---
---@param blip Blip
---@param r number
---@param g number
...
---**`HUD` `client` [`0x13127EC3665E8EE1`](https://docs.fivem.net/natives/?_0x13127EC3665E8EE1)**
---
---```
...
---**`HUD` `client` [`0x39BBF623FC803EAC`](https://docs.fivem.net/natives/?_0x39BBF623FC803EAC)**
---
...
---**`HUD` `client` [`0x784BA7E0ECEB4178`](https://docs.fivem.net/natives/?_0x784BA7E0ECEB4178)**
---
---@param hudIndex number
---@param x number
---@param y number
...
---**`HUD` `client` [`0x745711A75AB09277`](https://docs.fivem.net/natives/?_0x745711A75AB09277)**
---
---@param active boolean
function SetFrontendActive(active) end

---**`HUD` `client` [`0x900086F371220B6F`](https://docs.fivem.net/natives/?_0x900086F371220B6F)**
---
---@param toggle boolean
...
---**`HUD` `client` [`0x5B440763A4C8D15B`](https://docs.fivem.net/natives/?_0x5B440763A4C8D15B)**
---
---```
...
---**`HUD` `client` [`0x320D0E0D936A0E9B`](https://docs.fivem.net/natives/?_0x320D0E0D936A0E9B)**
---
---@param toggle boolean
function SetGpsFlashes(toggle) end

---**`HUD` `client` [`0x3DDA37128DD1ACA8`](https://docs.fivem.net/natives/?_0x3DDA37128DD1ACA8)**
---
---@param toggle boolean
function SetGpsMultiRouteRender(toggle) end

---**`HUD` `client` [`0x3F5CC444DCAAA8F2`](https://docs.fivem.net/natives/?_0x3F5CC444DCAAA8F2)**
---
---@param health number
...
---**`HUD` `client` [`0xAABB1F56E2A17CED`](https://docs.fivem.net/natives/?_0xAABB1F56E2A17CED)**
---
---@param id number
---@param x number
---@param y number
...
---**`HUD` `client` [`0x06A320535F5F0248`](https://docs.fivem.net/natives/?_0x06A320535F5F0248)**
---
---@param maximumValue number
function SetMaxArmourHudDisplay(maximumValue) end

---**`HUD` `client` [`0x975D66A0BC17064C`](https://docs.fivem.net/natives/?_0x975D66A0BC17064C)**
---
---@param maximumValue number
function SetMaxHealthHudDisplay(maximumValue) end

---**`HUD` `client` [`0x58FADDED207897DC`](https://docs.fivem.net/natives/?_0x58FADDED207897DC)**
---
---@param toggle boolean
function SetMinimapBlockWaypoint(toggle) end

---**`HUD` `client` [`0x75A9A10948D1DEA6`](https://docs.fivem.net/natives/?_0x75A9A10948D1DEA6)**
---
...
---**`HUD` `client` [`0x0923DBF87DFF735E`](https://docs.fivem.net/natives/?_0x0923DBF87DFF735E)**
---
---@param x number
---@param y number
---@param z number
...
---**`HUD` `client` [`0x71BDB63DBAF8DA59`](https://docs.fivem.net/natives/?_0x71BDB63DBAF8DA59)**
---
...
---**`HUD` `client` [`0x35EDD5B2E3FF01C0`](https://docs.fivem.net/natives/?_0x35EDD5B2E3FF01C0)**
---
function SetMinimapGolfCourseOff() end

---**`HUD` `client` [`0xF8DEE0A5600CBB93`](https://docs.fivem.net/natives/?_0xF8DEE0A5600CBB93)**
---
---```
...
---**`HUD` `client` [`0x9133955F1A2DA957`](https://docs.fivem.net/natives/?_0x9133955F1A2DA957)**
---
---```
...
---**`HUD` `client` [`0x1A5CD7752DD28CD3`](https://docs.fivem.net/natives/?_0x1A5CD7752DD28CD3)**
---
---@param toggle boolean
---@param ped Ped
...
---**`HUD` `client` [`0x7B7723747CCB55B6`](https://docs.fivem.net/natives/?_0x7B7723747CCB55B6)**
---
---@param gamerTagId number
---@param string string
function SetMpGamerTagBigText(gamerTagId, string) end

---**`HUD` `client` [`0x613ED644950626AE`](https://docs.fivem.net/natives/?_0x613ED644950626AE)**
---
...
---**`HUD` `client` [`0x3158C77A7E888AB4`](https://docs.fivem.net/natives/?_0x3158C77A7E888AB4)**
---
...
---**`HUD` `client` [`0xDEA2B8283BAA3944`](https://docs.fivem.net/natives/?_0xDEA2B8283BAA3944)**
---
---@param gamerTagId number
---@param string string
function SetMpGamerTagName(gamerTagId, string) end

---**`HUD` `client` [`0x63BB75ABEDC1F6A0`](https://docs.fivem.net/natives/?_0x63BB75ABEDC1F6A0)**
---
---```cpp
...
---**`HUD` `client` [`0xDD21B55DF695CD0A`](https://docs.fivem.net/natives/?_0xDD21B55DF695CD0A)**
---
---Preview image:
---
...
---**`HUD` `client` [`0xFD1D220394BCB824`](https://docs.fivem.net/natives/?_0xFD1D220394BCB824)**
---
---**This native does absolutely nothing, just a nullsub**
---
---@param p0 number
...
---**`HUD` `client` [`0xC2D15BEF167E27BC`](https://docs.fivem.net/natives/?_0xC2D15BEF167E27BC)**
---
---Preview image:
---
---![](https://i.imgur.com/1BTmdyv.png)
...
---**`HUD` `client` [`0xFE43368D2AA4F2FC`](https://docs.fivem.net/natives/?_0xFE43368D2AA4F2FC)**
---
---@param x number
---@param y number
...
---**`HUD` `client` [`0x3CA6050692BC61B0`](https://docs.fivem.net/natives/?_0x3CA6050692BC61B0)**
---
...
---**`HUD` `client` [`0xECF128344E9FF9F1`](https://docs.fivem.net/natives/?_0xECF128344E9FF9F1)**
---
...
---**`HUD` `client` [`0xE52B8E7F85D39A08`](https://docs.fivem.net/natives/?_0xE52B8E7F85D39A08)**
---
---@param ped Ped
---@param gangId number
function SetPedAiBlipGangId(ped, gangId) end

---**`HUD` `client` [`0x3EED80DFF7325CAA`](https://docs.fivem.net/natives/?_0x3EED80DFF7325CAA)**
---
---@param ped Ped
---@param toggle boolean
function SetPedAiBlipHasCone(ped, toggle) end

---**`HUD` `client` [`0x97C65887D4B37FA9`](https://docs.fivem.net/natives/?_0x97C65887D4B37FA9)**
---
---@param ped Ped
---@param range number
function SetPedAiBlipNoticeRange(ped, range) end

---**`HUD` `client` [`0xD30C50DF888D58B5`](https://docs.fivem.net/natives/?_0xD30C50DF888D58B5)**
---
---```
...
---**`HUD` `client` [`0x1EAC5F91BCBC5073`](https://docs.fivem.net/natives/?_0x1EAC5F91BCBC5073)**
---
---@param toggle boolean
function SetRaceTrackRender(toggle) end

---**`HUD` `client` [`0xE81B7D2A3DAB2D81`](https://docs.fivem.net/natives/?_0xE81B7D2A3DAB2D81)**
---
...
---**`HUD` `client` [`0xBD12C5EEE184C337`](https://docs.fivem.net/natives/?_0xBD12C5EEE184C337)**
---
---@param zoom number
function SetRadarZoomPrecise(zoom) end

---**`HUD` `client` [`0xF98E4B3E56AFC7B1`](https://docs.fivem.net/natives/?_0xF98E4B3E56AFC7B1)**
---
---@param blip Blip
---@param zoom number
function SetRadarZoomToBlip(blip, zoom) end

---**`HUD` `client` [`0xCB7CC0D58405AD41`](https://docs.fivem.net/natives/?_0xCB7CC0D58405AD41)**
---
---@param zoom number
...
---**`HUD` `client` [`0x9E778248D6685FE0`](https://docs.fivem.net/natives/?_0x9E778248D6685FE0)**
---
---```
...
---**`HUD` `client` [`0xC02F4DBFB51D988B`](https://docs.fivem.net/natives/?_0xC02F4DBFB51D988B)**
---
---@param align boolean
function SetTextCentre(align) end

---**`HUD` `client` [`0xBE6B23FFA53FB442`](https://docs.fivem.net/natives/?_0xBE6B23FFA53FB442)**
---
---```
...
---**`HUD` `client` [`0x465C84BC39F1C351`](https://docs.fivem.net/natives/?_0x465C84BC39F1C351)**
---
...
---**`HUD` `client` [`0x1CA3E9EAC9D93E5E`](https://docs.fivem.net/natives/?_0x1CA3E9EAC9D93E5E)**
---
function SetTextDropShadow() end

---**`HUD` `client` [`0x441603240D202FA6`](https://docs.fivem.net/natives/?_0x441603240D202FA6)**
---
---**This native does absolutely nothing, just a nullsub**
---
---@param p0 number
...
---**`HUD` `client` [`0xA50ABC31E3CDFAFF`](https://docs.fivem.net/natives/?_0xA50ABC31E3CDFAFF)**
---
---@param p0 number
function SetTextLeading(p0) end

---**`HUD` `client` [`0x2513DFB0FB8400FE`](https://docs.fivem.net/natives/?_0x2513DFB0FB8400FE)**
---
function SetTextOutline() end

---**`HUD` `client` [`0x038C1F517D7FDCF8`](https://docs.fivem.net/natives/?_0x038C1F517D7FDCF8)**
---
---**This native does absolutely nothing, just a nullsub**
---
---@param p0 boolean
...
---**`HUD` `client` [`0x5F15302936E07111`](https://docs.fivem.net/natives/?_0x5F15302936E07111)**
---
---@param renderId number
function SetTextRenderId(renderId) end

---**`HUD` `client` [`0x6B3C4650BC8BEE47`](https://docs.fivem.net/natives/?_0x6B3C4650BC8BEE47)**
---
---@param toggle boolean
function SetTextRightJustify(toggle) end

---**`HUD` `client` [`0x07C837F9A01C34C9`](https://docs.fivem.net/natives/?_0x07C837F9A01C34C9)**
---
---```
...
---**`HUD` `client` [`0xC3B07BA00A83B0F1`](https://docs.fivem.net/natives/?_0xC3B07BA00A83B0F1)**
---
---@param p0 any
function SetWidescreenFormat(p0) end

---**`HUD` `client` [`0xDCFB5D4DB8BF367E`](https://docs.fivem.net/natives/?_0xDCFB5D4DB8BF367E)**
---
...
---**`HUD` `client` [`0x23C3EB807312F01A`](https://docs.fivem.net/natives/?_0x23C3EB807312F01A)**
---
...
---**`HUD` `client` [`0x75A16C3DA34F1245`](https://docs.fivem.net/natives/?_0x75A16C3DA34F1245)**
---
---@param blip Blip
---@param toggle boolean
function ShowHeightOnBlip(blip, toggle) end

---**`HUD` `client` [`0x0B4DF1FA60C0E664`](https://docs.fivem.net/natives/?_0x0B4DF1FA60C0E664)**
---
...
---**`HUD` `client` [`0xA3C0B359DCB848B6`](https://docs.fivem.net/natives/?_0xA3C0B359DCB848B6)**
---
---@param blip Blip
---@param number number
function ShowNumberOnBlip(blip, number) end

---**`HUD` `client` [`0xB81656BC81FE24D1`](https://docs.fivem.net/natives/?_0xB81656BC81FE24D1)**
---
...
---**`HUD` `client` [`0xF1A6C18B35BCADE6`](https://docs.fivem.net/natives/?_0xF1A6C18B35BCADE6)**
---
---@param p0 boolean
...
---**`HUD` `client` [`0xDB34E8D56FC13B08`](https://docs.fivem.net/natives/?_0xDB34E8D56FC13B08)**
---
...
---**`HUD` `client` [`0x3D3D15AF7BCAAF83`](https://docs.fivem.net/natives/?_0x3D3D15AF7BCAAF83)**
---
...
---**`HUD` `client` [`0xBA751764F0821256`](https://docs.fivem.net/natives/?_0xBA751764F0821256)**
---
function SuppressFrontendRenderingThisFrame() end

---**`HUD` `client` [`0xEC9264727EEC0F28`](https://docs.fivem.net/natives/?_0xEC9264727EEC0F28)**
---
...
---**`HUD` `client` [`0x80FE4F3AB4E1B62A`](https://docs.fivem.net/natives/?_0x80FE4F3AB4E1B62A)**
---
function ThefeedClearFrozenPost() end

---**`HUD` `client` [`0xADED7F5748ACAFE6`](https://docs.fivem.net/natives/?_0xADED7F5748ACAFE6)**
---
---```
...
---**`HUD` `client` [`0x56C8B608CFD49854`](https://docs.fivem.net/natives/?_0x56C8B608CFD49854)**
---
---```
...
---**`HUD` `client` [`0xA8FDB297A8D25FBA`](https://docs.fivem.net/natives/?_0xA8FDB297A8D25FBA)**
---
function ThefeedFlushQueue() end

---**`HUD` `client` [`0x583049884A2EEE3C`](https://docs.fivem.net/natives/?_0x583049884A2EEE3C)**
---
---Enables loading screen tips to be be shown (`_0x15CFA549788D35EF` and `_0x488043841BBE156F`), blocks other kinds of notifications from being displayed (at least from current script). Call `0xADED7F5748ACAFE6` to display those again.
---
function ThefeedForceRenderOff() end

---**`HUD` `client` [`0xA13C11E1B5C06BFC`](https://docs.fivem.net/natives/?_0xA13C11E1B5C06BFC)**
---
function ThefeedForceRenderOn() end

---**`HUD` `client` [`0xFDEC055AB549E328`](https://docs.fivem.net/natives/?_0xFDEC055AB549E328)**
---
---```
...
---**`HUD` `client` [`0x82352748437638CA`](https://docs.fivem.net/natives/?_0x82352748437638CA)**
---
---```
...
---**`HUD` `client` [`0x25F87B30C382FCA7`](https://docs.fivem.net/natives/?_0x25F87B30C382FCA7)**
---
---Once called each frame hides all above radar notifications.
---
function ThefeedHideThisFrame() end

---**`HUD` `client` [`0xA9CBFD40B3FA3010`](https://docs.fivem.net/natives/?_0xA9CBFD40B3FA3010)**
---
---@return boolean
function ThefeedIsPaused() end

---**`HUD` `client` [`0x6F1554B0CC2089FA`](https://docs.fivem.net/natives/?_0x6F1554B0CC2089FA)**
---
---@param toggle boolean
function ThefeedOnlyShowTooltips(toggle) end

---**`HUD` `client` [`0xFDB423997FA30340`](https://docs.fivem.net/natives/?_0xFDB423997FA30340)**
---
...
---**`HUD` `client` [`0xFDD85225B2DEA55E`](https://docs.fivem.net/natives/?_0xFDD85225B2DEA55E)**
---
function ThefeedResetAllParameters() end

---**`HUD` `client` [`0xE1CD1E48E025E661`](https://docs.fivem.net/natives/?_0xE1CD1E48E025E661)**
---
function ThefeedResume() end

---**`HUD` `client` [`0x55598D21339CB998`](https://docs.fivem.net/natives/?_0x55598D21339CB998)**
---
---@param pos number
function ThefeedSetScriptedMenuHeight(pos) end

---**`HUD` `client` [`0xB695E2CD0A2DA9EE`](https://docs.fivem.net/natives/?_0xB695E2CD0A2DA9EE)**
---
function ThefeedSpsExtendWidescreenOff() end

---**`HUD` `client` [`0xD4438C0564490E63`](https://docs.fivem.net/natives/?_0xD4438C0564490E63)**
---
function ThefeedSpsExtendWidescreenOn() end

---**`HUD` `client` [`0x317EBA71D7543F52`](https://docs.fivem.net/natives/?_0x317EBA71D7543F52)**
---
---```
...
---**`HUD` `client` [`0x6AFDFB93754950C7`](https://docs.fivem.net/natives/?_0x6AFDFB93754950C7)**
---
---@param toggle boolean
function ToggleStealthRadar(toggle) end

---**`HUD` `client` [`0x72DD432F3CDFC0EE`](https://docs.fivem.net/natives/?_0x72DD432F3CDFC0EE)**
---
---@param posX number
---@param posY number
---@param posZ number
...
---**`HUD` `client` [`0x8183455E16C42E3A`](https://docs.fivem.net/natives/?_0x8183455E16C42E3A)**
---
function UnlockMinimapAngle() end

---**`HUD` `client` [`0x3E93E06DB8EF1F30`](https://docs.fivem.net/natives/?_0x3E93E06DB8EF1F30)**
---
function UnlockMinimapPosition() end

---**`HUD` `client` [`0x170F541E1CADD1DE`](https://docs.fivem.net/natives/?_0x170F541E1CADD1DE)**
---
---```
...
---**`HUD` `client` [`0xCE5D0E5E315DB238`](https://docs.fivem.net/natives/?_0xCE5D0E5E315DB238)**
---
...
---**`HUD` `client` [`0xCC3FDDED67BCFC63`](https://docs.fivem.net/natives/?_0xCC3FDDED67BCFC63)**
---
...
---**`HUD` `client` [`0x54CE8AC98E120CAB`](https://docs.fivem.net/natives/?_0x54CE8AC98E120CAB)**
---
---```
---BEGIN_TEXT_COMMAND_*
---Example:
...
---**`HUD` `client` [`0x23D69E0465570028`](https://docs.fivem.net/natives/?_0x23D69E0465570028)**
---
---@param p0 string
function BeginTextCommandObjective(p0) end

---**`HUD` `client` [`0xD12882D3FF82BF11`](https://docs.fivem.net/natives/?_0xD12882D3FF82BF11)**
---
---Clears all active blip routes that have been set with [`SetBlipRoute`](#\_0x3E160C90).
---
function ClearAllBlipRoutes() end

---**`HUD` `client` [`0x2708FC083123F9FF`](https://docs.fivem.net/natives/?_0x2708FC083123F9FF)**
---
function ClearRaceGalleryBlips() end

---**`HUD` `client` [`0x1AC8F4AD40E22127`](https://docs.fivem.net/natives/?_0x1AC8F4AD40E22127)**
---
function CloseMultiplayerChat() end

---**`HUD` `client` [`0xD8E694757BCEA8E9`](https://docs.fivem.net/natives/?_0xD8E694757BCEA8E9)**
---
function DeleteWaypoint() end

---**`HUD` `client` [`0x1DB21A44B09E8BA3`](https://docs.fivem.net/natives/?_0x1DB21A44B09E8BA3)**
---
...
---**`HUD` `client` [`0x7669F9E39DC17063`](https://docs.fivem.net/natives/?_0x7669F9E39DC17063)**
---
...
---**`HUD` `client` [`0x85F061DA64ED2F67`](https://docs.fivem.net/natives/?_0x85F061DA64ED2F67)**
---
---```
---END_TEXT_COMMAND_*
...
---**`HUD` `client` [`0x9040DFB09BE75706`](https://docs.fivem.net/natives/?_0x9040DFB09BE75706)**
---
---```
---END_TEXT_COMMAND_*
...
---**`HUD` `client` [`0xCFDBDF5AE59BA0F4`](https://docs.fivem.net/natives/?_0xCFDBDF5AE59BA0F4)**
---
---@param p0 boolean
function EndTextCommandObjective(p0) end

---**`HUD` `client` [`0xC6F580E4C94926AC`](https://docs.fivem.net/natives/?_0xC6F580E4C94926AC)**
---
...
---**`HUD` `client` [`0xDD6CB2CCE7C2735C`](https://docs.fivem.net/natives/?_0xDD6CB2CCE7C2735C)**
---
---```
---returns a notification handle, prints out a notification like below:
---type range: 0 - 2
...
---**`HUD` `client` [`0x8817605C2BA76200`](https://docs.fivem.net/natives/?_0x8817605C2BA76200)**
---
...
---**`HUD` `client` [`0x7CD934010E115C2C`](https://docs.fivem.net/natives/?_0x7CD934010E115C2C)**
---
---@param ped Ped
---@return Blip
function GetAiBlip_2(ped) end

---**`HUD` `client` [`0x003E92BA477F9D7F`](https://docs.fivem.net/natives/?_0x003E92BA477F9D7F)**
---
---```
---NativeDB Introduced: v2060
---```
...
---**`HUD` `client` [`0xD484BF71050CA1EE`](https://docs.fivem.net/natives/?_0xD484BF71050CA1EE)**
---
---```
---NativeDB Introduced: v1180
---```
...
---**`HUD` `client` [`0x7B5280EBA9840C72`](https://docs.fivem.net/natives/?_0x7B5280EBA9840C72)**
---
---```
...
---**`HUD` `client` [`0x3F0CF9CB7E589B88`](https://docs.fivem.net/natives/?_0x3F0CF9CB7E589B88)**
---
---@return Blip
function GetNorthRadarBlip() end

---**`HUD` `client` [`0x5BFF36D6ED83E0AE`](https://docs.fivem.net/natives/?_0x5BFF36D6ED83E0AE)**
---
---Name between `GET_ONSCREEN_KEYBOARD_RESULT` and `GET_PAUSE_MENU_STATE`. Likely, `GET_PAUSE_MENU_*`.
---
---@return vector3 # If the pause menu is open, it will return a Vector3, Z is always 0.<br>If the pause menu is closed, it will return Vector3.Zero
function GetPauseMenuCursorPosition() end

---**`HUD` `client` [`0x36C1451A88A09630`](https://docs.fivem.net/natives/?_0x36C1451A88A09630)**
---
...
---**`HUD` `client` [`0x7E17BE53E1AAABAF`](https://docs.fivem.net/natives/?_0x7E17BE53E1AAABAF)**
---
---```
...
---**`HUD` `client` [`0x632B2940C67F4EA9`](https://docs.fivem.net/natives/?_0x632B2940C67F4EA9)**
---
...
---**`HUD` `client` [`0x169BD9382084C8C0`](https://docs.fivem.net/natives/?_0x169BD9382084C8C0)**
---
---```
...
---**`HUD` `client` [`0xB2798643312205C5`](https://docs.fivem.net/natives/?_0xB2798643312205C5)**
---
---```
...
---**`HUD` `client` [`0xCE94AEBA5D82908A`](https://docs.fivem.net/natives/?_0xCE94AEBA5D82908A)**
---
---```
...
---**`HUD` `client` [`0x81DF9ABA6C83DFF9`](https://docs.fivem.net/natives/?_0x81DF9ABA6C83DFF9)**
---
---```
---NativeDB Introduced: v1290
---```
...
---**`HUD` `client` [`0xA277800A9EAE340E`](https://docs.fivem.net/natives/?_0xA277800A9EAE340E)**
---
---```
---HAS_*
---```
...
---**`HUD` `client` [`0xA4DEDE28B1814289`](https://docs.fivem.net/natives/?_0xA4DEDE28B1814289)**
---
---```
---HIDE_*_THIS_FRAME
---
...
---**`HUD` `client` [`0x488043841BBE156F`](https://docs.fivem.net/natives/?_0x488043841BBE156F)**
---
...
---**`HUD` `client` [`0xA48931185F0536FE`](https://docs.fivem.net/natives/?_0xA48931185F0536FE)**
---
---```
...
---**`HUD` `client` [`0xA13E93403F26C812`](https://docs.fivem.net/natives/?_0xA13E93403F26C812)**
---
---```
...
---**`HUD` `client` [`0x14C9FDCC41F81F63`](https://docs.fivem.net/natives/?_0x14C9FDCC41F81F63)**
---
---```
...
---**`HUD` `client` [`0x0AFC4AF510774B47`](https://docs.fivem.net/natives/?_0x0AFC4AF510774B47)**
---
---```
...
---**`HUD` `client` [`0xEB709A36958ABE0D`](https://docs.fivem.net/natives/?_0xEB709A36958ABE0D)**
---
---```
---IS_*
---```
...
---**`HUD` `client` [`0xAF42195A42C63BBA`](https://docs.fivem.net/natives/?_0xAF42195A42C63BBA)**
---
---```
---IS_WARNING_MESSAGE_*
---```
...
---**`HUD` `client` [`0x2162C446DFDF38FD`](https://docs.fivem.net/natives/?_0x2162C446DFDF38FD)**
---
---```
...
---**`HUD` `client` [`0xF47E567B3630DD12`](https://docs.fivem.net/natives/?_0xF47E567B3630DD12)**
---
---@param p0 number
---@param hudColor number
function OverrideMultiplayerChatColour(p0, hudColor) end

---**`HUD` `client` [`0x6A1738B4323FE2D9`](https://docs.fivem.net/natives/?_0x6A1738B4323FE2D9)**
---
---@param gxtEntryHash Hash
function OverrideMultiplayerChatPrefix(gxtEntryHash) end

---**`HUD` `client` [`0x9245E81072704B8A`](https://docs.fivem.net/natives/?_0x9245E81072704B8A)**
---
...
---**`HUD` `client` [`0x359AF31A4B52F5ED`](https://docs.fivem.net/natives/?_0x359AF31A4B52F5ED)**
---
...
---**`HUD` `client` [`0x13C4B962653A5280`](https://docs.fivem.net/natives/?_0x13C4B962653A5280)**
---
...
---**`HUD` `client` [`0x551DF99658DB6EE8`](https://docs.fivem.net/natives/?_0x551DF99658DB6EE8)**
---
---```
...
---**`HUD` `client` [`0x5354C5BA2EA868A4`](https://docs.fivem.net/natives/?_0x5354C5BA2EA868A4)**
---
---```
...
---**`HUD` `client` [`0x1EAE6DD17B7A5EFA`](https://docs.fivem.net/natives/?_0x1EAE6DD17B7A5EFA)**
---
---```
...
---**`HUD` `client` [`0x6EF54AB721DC6242`](https://docs.fivem.net/natives/?_0x6EF54AB721DC6242)**
---
function RemoveWarningMessageListItems() end

---**`HUD` `client` [`0x1DFEDD15019315A9`](https://docs.fivem.net/natives/?_0x1DFEDD15019315A9)**
---
---```
...
---**`HUD` `client` [`0x889329C80FE5963C`](https://docs.fivem.net/natives/?_0x889329C80FE5963C)**
---
---```
...
---**`HUD` `client` [`0xC4278F70131BAA6D`](https://docs.fivem.net/natives/?_0xC4278F70131BAA6D)**
---
---```
...
---**`HUD` `client` [`0xCD6524439909C979`](https://docs.fivem.net/natives/?_0xCD6524439909C979)**
---
...
---**`HUD` `client` [`0x2B6D467DAB714E8D`](https://docs.fivem.net/natives/?_0x2B6D467DAB714E8D)**
---
---```
...
---**`HUD` `client` [`0xA8B6AFDAC320AC87`](https://docs.fivem.net/natives/?_0xA8B6AFDAC320AC87)**
---
---```
...
---**`HUD` `client` [`0x2632482FD6B9AB87`](https://docs.fivem.net/natives/?_0x2632482FD6B9AB87)**
---
---```
---SET_*
---```
...
---**`HUD` `client` [`0xB9C362BABECDDC7A`](https://docs.fivem.net/natives/?_0xB9C362BABECDDC7A)**
---
---@param style number
---@param hudColor number
---@param alpha number
...
---**`HUD` `client` [`0x7EC8ABA5E74B3D7A`](https://docs.fivem.net/natives/?_0x7EC8ABA5E74B3D7A)**
---
---```
...
---**`HUD` `client` [`0x504DFE62A1692296`](https://docs.fivem.net/natives/?_0x504DFE62A1692296)**
---
---```
---NativeDB Introduced: v1493
---```
...
---**`HUD` `client` [`0x7B21E0BB01E8224A`](https://docs.fivem.net/natives/?_0x7B21E0BB01E8224A)**
---
---@param color number
...
---**`HUD` `client` [`0xAAE7CE1D63167423`](https://docs.fivem.net/natives/?_0xAAE7CE1D63167423)**
---
---```
...
---**`HUD` `client` [`0x98215325A695E78A`](https://docs.fivem.net/natives/?_0x98215325A695E78A)**
---
...
---**`HUD` `client` [`0xD29EC58C2F6B5014`](https://docs.fivem.net/natives/?_0xD29EC58C2F6B5014)**
---
...
---**`HUD` `client` [`0x1563FE35E9928E67`](https://docs.fivem.net/natives/?_0x1563FE35E9928E67)**
---
...
---**`HUD` `client` [`0xA67F9C46D612B6F1`](https://docs.fivem.net/natives/?_0xA67F9C46D612B6F1)**
---
...
---**`HUD` `client` [`0xEE76FF7E6A0166B0`](https://docs.fivem.net/natives/?_0xEE76FF7E6A0166B0)**
---
...
---**`HUD` `client` [`0xFCFACD0DB9D7A57D`](https://docs.fivem.net/natives/?_0xFCFACD0DB9D7A57D)**
---
---@param ped Ped
---@param spriteId number
function SetPedAiBlipSprite(ped, spriteId) end

---**`HUD` `client` [`0xB13DCB4C6FAAD238`](https://docs.fivem.net/natives/?_0xB13DCB4C6FAAD238)**
---
---@param ped Ped
---@param hasCone boolean
...
---**`HUD` `client` [`0x16A304E6CB2BFAB9`](https://docs.fivem.net/natives/?_0x16A304E6CB2BFAB9)**
---
---```
...
---**`HUD` `client` [`0x0C5A80A9E096D529`](https://docs.fivem.net/natives/?_0x0C5A80A9E096D529)**
---
---```
...
---**`HUD` `client` [`0x15803FEC3B9A872B`](https://docs.fivem.net/natives/?_0x15803FEC3B9A872B)**
---
---instructionalKey enum list:
---
---```
...
---**`HUD` `client` [`0xCAC2031EBF79B1A8`](https://docs.fivem.net/natives/?_0xCAC2031EBF79B1A8)**
---
---```
...
---**`HUD` `client` [`0x4F38DCA127DAAEA2`](https://docs.fivem.net/natives/?_0x4F38DCA127DAAEA2)**
---
---SHOW_\*
---
---```
...
---**`HUD` `client` [`0x60E892BA4F5BDCA4`](https://docs.fivem.net/natives/?_0x60E892BA4F5BDCA4)**
---
function ShowSigninUi() end

---**`HUD` `client` [`0x32888337579A5970`](https://docs.fivem.net/natives/?_0x32888337579A5970)**
---
...
---**`HUD` `client` [`0x15CFA549788D35EF`](https://docs.fivem.net/natives/?_0x15CFA549788D35EF)**
---
...
---**`HUD` `client` [`0x17430B918701C342`](https://docs.fivem.net/natives/?_0x17430B918701C342)**
---
---@param red number
---@param green number
---@param blue number
...
---**`HUD` `client` [`0x17AD8C9706BDD88A`](https://docs.fivem.net/natives/?_0x17AD8C9706BDD88A)**
---
...
---**`HUD` `client` [`0x4A0C7C9BB10ABB36`](https://docs.fivem.net/natives/?_0x4A0C7C9BB10ABB36)**
---
---```
...
---**`HUD` `client` [`0xBAE4F9B97CD43B30`](https://docs.fivem.net/natives/?_0xBAE4F9B97CD43B30)**
---
---```
...
---**`HUD` `client` [`0x92F0DA1E27DB96DC`](https://docs.fivem.net/natives/?_0x92F0DA1E27DB96DC)**
---
---```
