...
---
---@return boolean # Whether recording is currently running, true when you start recording (F1) or turn on action replay (F2)
...
---
---@param mode number 0 turns on action replay, 1 starts recording
